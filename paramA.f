C $Id: paramA.f,v 1.1 2003/06/30 20:26:01 bmy Exp $
C**********************************************************************
...
C**********************************************************************
C SR PARAMA is called by SR CLEAN.  Based on season and latitude, this
...
C parameterizations found in the "CLEAN" subdomain.  In the boxes labeled 
