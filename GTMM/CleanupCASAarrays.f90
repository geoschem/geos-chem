      ...
      IF (ALLOCATED(soilmicDecayFactor)) &
      DEALLOCATE(soilmicDecayFactor)
      IF (ALLOCATED(slowDecayFactor)) DEALLOCATE(slowDecayFactor)
      IF (ALLOCATED(armoredDecayFactor)) &
      DEALLOCATE(armoredDecayFactor)
      ...
      IF (ALLOCATED(carbonout_abovewood)) &
      DEALLOCATE(carbonout_abovewood)
      IF (ALLOCATED(carbonout_belowwood)) &
      DEALLOCATE(carbonout_belowwood)
      ...
      IF (ALLOCATED(nonCombusted_abovewood)) &
      DEALLOCATE(nonCombusted_abovewood)
      IF (ALLOCATED(nonCombusted_belowwood)) &
      DEALLOCATE(nonCombusted_belowwood)
