      ...
      IF (yr .eq. 1 .and. mo .eq. 1) THEN
              NPPmonthly=NPPmonthly*0.0d0
              respmonthly=respmonthly*0.0d0
              combmonthly=combmonthly*0.0d0
              herbmonthly=herbmonthly*0.0d0
              biofmonthly=biofmonthly*0.0d0
      
              respmonthly_hg=respmonthly_hg*0.00d0
              combmonthly_hg=combmonthly_hg*0.00d0
              reemmonthly_hg=reemmonthly_hg*0.00d0
              photmonthly_hg=photmonthly_hg*0.00d0
	      biomeAnnual_Hg=biomeAnnual_Hg*0.00d0
      ENDIF 
      st(:)=0.0d0
