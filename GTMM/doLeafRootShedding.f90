      ...
      !define the scalars that predict the seasonality of leaf 
      !shedding and root decay based on changes in LAI
      !This needs improvement
      !See Randerson, Thompson, Malmstrom, Field and Fung 1996
      !GBC 10(4) p585
...
!--- Moved to the end to simplify parallelization. (ccc, 11/9/09)
