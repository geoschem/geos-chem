C $Id: paramD.f,v 1.1 2003/06/30 20:26:01 bmy Exp $
C**********************************************************************
...
C**********************************************************************
C SR PARAMD is called by SR MODPOLLUTEDISOP.  Based on season and latitude,
C this subroutine choses the appropriate identification number of the
C parameterization required for the surface layer only.
C
C  ----------------------------------------------------------
C  | Latitude   |   DJF    |   MAM    |   JJA    |   SON    |
C  ----------------------------------------------------------
C  |   > 80 N   |   AVG    |   AVG    |    *     |   AVG    |
C  |  60-80 N   |   AVG    |    *     |    22    |   AVG    |
C  |  40-60 N   |   AVG    |    19    |    20    |    21    |
C  |  30-40 N   |     15   |    16    |    17    |    18    |
C  |   0-30 N   |     11   |    12    |    13    |    14    |
C  |   0-30 S   |     7    |    8     |    9     |    10    |
C  |  30-40 S   |     3    |    4     |    5     |    6     |
C  |  40-60 S   |     1    |    *     |    *     |    2     |
C  |  60-80 S   |     *    |   AVG    |   AVG    |    *     |
...
C parameterized OH is calculated. The number in the box corresponds
...
C 15N in April has the identification number 12.
