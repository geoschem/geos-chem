! $Id: global_ch4_mod.f,v 1.9 2006/06/06 14:26:05 bmy Exp $
      MODULE GLOBAL_CH4_MOD
!
!******************************************************************************
!  Module GLOBAL_CH4_MOD contains variables and routines for simulating
!  CH4 chemistry in the troposphere (jsw, bnd, bmy, 1/17/01, 5/30/06)
!
!  Module Variables:
!  =========================================================================== 
...
!  (23) Remove GET_GLOBAL_CH4 from the module (bmy, 5/30/06)
!******************************************************************************
!     
      IMPLICIT NONE
...
!------------------------------------------------------------------------------
! Prior to 5/31/06:
! Split this off from the module, since this is for SMVGEAR, and the rest
! of the module is for the offline CH4 simulation (swu, bmy, 5/30/06)
