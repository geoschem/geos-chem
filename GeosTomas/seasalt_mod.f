! $Id: seasalt_mod.f,v 1.1 2010/02/02 16:57:48 bmy Exp $
      MODULE SEASALT_MOD
!
!******************************************************************************
...
!  (12) tomas_mod.f        : Module w/ TOMAS microphysics variables
!
!  References:
!  ============================================================================
...
!$OMP END PARALLEL DO
      ...
      IF ( IDTSS1 > 0 ) THEN
         ...
         ! For now, stop the run if choose to use Lin's PBL scheme when running TOMAS aerosols (win, 7/17/09)
         IF( LNLPBL ) THEN
     ...
     &                   STT(:,:,:,IDTSS1:IDTSS1+IBINS-1 ) )
         IF ( LPRT ) CALL DEBUG_MSG( '### EMISSSEASALT: 30-Bin' )
      ENDIF
...
!------------------------------------------------------------------------------
      ...
      SUBROUTINE SRCSALT30( TC1, TC2 )
!
!******************************************************************************
!  Subroutine SRCSALT30 emits sea-salt into the 30-bin sea-salt mass and 
!  aerosol number arrays.  Sea-salt emission parameterization of Clarke et al.
!  [2006] (win, 7/17/09)
! 
...
!  ============================================================================
!  (1 ) TC1 (REAL*8 ) : Aerosol number tracer array [no.]
!  (2 ) TC2 (REAL*8 ) : Sea salt tracer array [kg]
!
!  References:
!  ============================================================================
...
#      include "CMN_DEP"       ! FRCLND
      ...
      DATA Dbin /9.68859E-09,1.22069E-08,1.53797E-08,1.93772E-08,
     & 2.44137E-08,3.07594E-08,3.87544E-08,4.88274E-08,6.15187E-08,
     & 7.75087E-08,9.76549E-08,1.23037E-07,1.55017E-07,1.9531E-07,
     & 2.46075E-07,3.10035E-07,3.9062E-07,4.9215E-07,6.2007E-07,
     & 7.81239E-07,9.843E-07,1.24014E-06,1.56248E-06,1.9686E-06,
     & 2.48028E-06,3.12496E-06,3.9372E-06,4.96056E-06,6.24991E-06,
     & 7.8744E-06/

      DATA A /1719793.975,2887719.254,4086059.079,5222972.121,
      ...
      DO I = 1, IIPAR
         ...
         IF (FOCEAN > 0.5) THEN 
            ...
            DO  K = 1, IBINS
               ...
               !================================================================
               NUM = F100 * W * A_M2(J) * FOCEAN * DTEMIS * COEF
