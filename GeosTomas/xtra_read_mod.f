...
!
!  NOTES:
!  (1 ) For year 2000 fields, only look for 5 XTRA fields (win, 7/28/09)
!******************************************************************************
!
      ! References to F90 modules
...
#     include "CMN_DIAG"              ! ND67
      ...
      INTEGER                        :: YEAR  !(win, 7/28/09)
    
      !=================================================================
      ! READ_XTRA begins here!      
      !=================================================================

      ! Give alternative value for N_XTRA because there are fewer fields 
      ! for year 2000. (win, 7/28/09)
      YEAR = INT( NYMD / 10000 )
