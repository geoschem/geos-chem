...
!
!******************************************************************************
!  Subroutine SETTLEDUST is the interface between the size-resolved dry 
!  deposition subroutine AERO_DRYDEP and the dust module. This is to call only
!  gravitational settling and deals with removal of aerosol number with the 
!  dust mass.  (win, 7/17/09)
!
!  NOTES:
!
!******************************************************************************
...
!  (3 ) IPOINT array now get its value inside the code to accomodate the
!        options of using 4-bin dust or 30-bin dust (microphysics simulation)
!        (win, 3/11/08)
!  (4 ) Add a factor of 2.00 to reduce dust emission in the China 1x1 nested-grid 
!       domain.  (win, 4/27/08)
!******************************************************************************
!     
      ! References to F90 modules
