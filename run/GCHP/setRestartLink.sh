...
#    ./Restart/GEOSChem.Restart.YYYYMMDD_HHmmSSz.cN.nc4, where YYYYMMDD and
#    HHmmSS are the simulation start date and time set in file cap_restart,
...
rst_target=./Restarts/GEOSChem.Restart.${start_str}z.c${N}.nc4
