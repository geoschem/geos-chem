...
# setupConfigFiles.sh: Update config file default settings based on
# simulation selected
#
# Argument: Extra option for full-chemistry simulation
#
# Example usage: setupConfigFiles.sh benchmark
#
