...
!
    ...
    IF ( am_I_Root ) THEN
       WRITE(6,*) ' '
       IF ( Phase == 1 ) THEN
          WRITE(6,*) 'Reading settings & switches of HEMCO configuration file: ', TRIM(ConfigFile)
       ELSEIF ( Phase == 2 ) THEN
          WRITE(6,*) 'Reading fields of HEMCO configuration file: ', TRIM(ConfigFile)
       ELSE
          WRITE(6,*) 'Reading entire HEMCO configuration file: ', TRIM(ConfigFile)
       ENDIF
    ENDIF
