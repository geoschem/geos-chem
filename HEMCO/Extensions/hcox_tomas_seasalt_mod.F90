...
!
    ...
    DO K = 1, HcoState%MicroPhys%nBins
       ...
       IF ( K==8  ) SpcName = 'SS8'
       IF ( K==9  ) SpcName = 'SS9'
       IF ( K==10 ) SpcName = 'SS10'
       IF ( K==11 ) SpcName = 'SS11'
       IF ( K==12 ) SpcName = 'SS12'
       IF ( K==13 ) SpcName = 'SS13'
       IF ( K==14 ) SpcName = 'SS14'
       IF ( K==15 ) SpcName = 'SS15'
       IF ( K==16 ) SpcName = 'SS16'
       IF ( K==17 ) SpcName = 'SS17'
       IF ( K==18 ) SpcName = 'SS18'
       IF ( K==19 ) SpcName = 'SS19'
       IF ( K==20 ) SpcName = 'SS20'
       IF ( K==21 ) SpcName = 'SS21'
       IF ( K==22 ) SpcName = 'SS22'
       IF ( K==23 ) SpcName = 'SS23'
       IF ( K==24 ) SpcName = 'SS24'
       IF ( K==25 ) SpcName = 'SS25'
       IF ( K==26 ) SpcName = 'SS26'
       IF ( K==27 ) SpcName = 'SS27'
       IF ( K==28 ) SpcName = 'SS28'
       IF ( K==29 ) SpcName = 'SS29'
       IF ( K==30 ) SpcName = 'SS30'
       IF ( K==31 ) SpcName = 'SS31'
       IF ( K==32 ) SpcName = 'SS32'
       IF ( K==33 ) SpcName = 'SS33'
       IF ( K==34 ) SpcName = 'SS34'
       IF ( K==35 ) SpcName = 'SS35'
       IF ( K==36 ) SpcName = 'SS36'
       IF ( K==37 ) SpcName = 'SS37'
       IF ( K==38 ) SpcName = 'SS38'
       IF ( K==39 ) SpcName = 'SS39'
       IF ( K==40 ) SpcName = 'SS40'
