...
! TEMPORARY TO TEST GCHP DRYDEP UPDATES (ewl, 10/12/16)
     ! Olson fractional coverage per land type (eventually use MAPL ptr)
     REAL(fp), POINTER :: OLSON00   (:,:) ! olson land type == 0
     REAL(fp), POINTER :: OLSON01   (:,:) ! olson land type == 1
     REAL(fp), POINTER :: OLSON02   (:,:) ! olson land type == 2
     REAL(fp), POINTER :: OLSON03   (:,:) ! etc
     ...
     ! LAI per land type avg'd over entire cell
     REAL(fp), POINTER :: XLAI00    (:,:)
     REAL(fp), POINTER :: XLAI01    (:,:)  
     REAL(fp), POINTER :: XLAI02    (:,:)  
     REAL(fp), POINTER :: XLAI03    (:,:)  
     REAL(fp), POINTER :: XLAI04    (:,:)  
     REAL(fp), POINTER :: XLAI05    (:,:)  
     REAL(fp), POINTER :: XLAI06    (:,:)  
     REAL(fp), POINTER :: XLAI07    (:,:)  
     REAL(fp), POINTER :: XLAI08    (:,:)  
     REAL(fp), POINTER :: XLAI09    (:,:)  
     REAL(fp), POINTER :: XLAI10    (:,:)  
     REAL(fp), POINTER :: XLAI11    (:,:)  
     REAL(fp), POINTER :: XLAI12    (:,:)  
     REAL(fp), POINTER :: XLAI13    (:,:)  
     REAL(fp), POINTER :: XLAI14    (:,:)  
     REAL(fp), POINTER :: XLAI15    (:,:)  
     REAL(fp), POINTER :: XLAI16    (:,:)  
     REAL(fp), POINTER :: XLAI17    (:,:)  
     REAL(fp), POINTER :: XLAI18    (:,:)  
     REAL(fp), POINTER :: XLAI19    (:,:)  
     REAL(fp), POINTER :: XLAI20    (:,:)  
     REAL(fp), POINTER :: XLAI21    (:,:)  
     REAL(fp), POINTER :: XLAI22    (:,:)  
     REAL(fp), POINTER :: XLAI23    (:,:)  
     REAL(fp), POINTER :: XLAI24    (:,:)  
     REAL(fp), POINTER :: XLAI25    (:,:)  
     REAL(fp), POINTER :: XLAI26    (:,:)  
     REAL(fp), POINTER :: XLAI27    (:,:)  
     REAL(fp), POINTER :: XLAI28    (:,:)  
     REAL(fp), POINTER :: XLAI29    (:,:)  
     REAL(fp), POINTER :: XLAI30    (:,:)  
     REAL(fp), POINTER :: XLAI31    (:,:)  
     REAL(fp), POINTER :: XLAI32    (:,:)  
     REAL(fp), POINTER :: XLAI33    (:,:)  
     REAL(fp), POINTER :: XLAI34    (:,:)  
     REAL(fp), POINTER :: XLAI35    (:,:)  
     REAL(fp), POINTER :: XLAI36    (:,:)  
     REAL(fp), POINTER :: XLAI37    (:,:)  
     REAL(fp), POINTER :: XLAI38    (:,:)  
     REAL(fp), POINTER :: XLAI39    (:,:)  
     REAL(fp), POINTER :: XLAI40    (:,:)  
     REAL(fp), POINTER :: XLAI41    (:,:)  
     REAL(fp), POINTER :: XLAI42    (:,:)  
     REAL(fp), POINTER :: XLAI43    (:,:)  
     REAL(fp), POINTER :: XLAI44    (:,:)  
     REAL(fp), POINTER :: XLAI45    (:,:)  
     REAL(fp), POINTER :: XLAI46    (:,:)  
     REAL(fp), POINTER :: XLAI47    (:,:)  
     REAL(fp), POINTER :: XLAI48    (:,:)  
     REAL(fp), POINTER :: XLAI49    (:,:)  
     REAL(fp), POINTER :: XLAI50    (:,:)  
     REAL(fp), POINTER :: XLAI51    (:,:)  
     REAL(fp), POINTER :: XLAI52    (:,:)  
     REAL(fp), POINTER :: XLAI53    (:,:)  
     REAL(fp), POINTER :: XLAI54    (:,:)  
     REAL(fp), POINTER :: XLAI55    (:,:)  
     REAL(fp), POINTER :: XLAI56    (:,:)  
     REAL(fp), POINTER :: XLAI57    (:,:)  
     REAL(fp), POINTER :: XLAI58    (:,:)  
     REAL(fp), POINTER :: XLAI59    (:,:)  
     REAL(fp), POINTER :: XLAI60    (:,:)  
     REAL(fp), POINTER :: XLAI61    (:,:)  
     REAL(fp), POINTER :: XLAI62    (:,:)  
     REAL(fp), POINTER :: XLAI63    (:,:)  
     REAL(fp), POINTER :: XLAI64    (:,:)  
     REAL(fp), POINTER :: XLAI65    (:,:)  
     REAL(fp), POINTER :: XLAI66    (:,:)  
     REAL(fp), POINTER :: XLAI67    (:,:)  
     REAL(fp), POINTER :: XLAI68    (:,:)  
     REAL(fp), POINTER :: XLAI69    (:,:)  
     REAL(fp), POINTER :: XLAI70    (:,:)  
     REAL(fp), POINTER :: XLAI71    (:,:)  
     REAL(fp), POINTER :: XLAI72    (:,:)  
     REAL(fp), POINTER :: XLAI73    (:,:)  
     REAL(fp), POINTER :: XLAI74    (:,:)  
     ! Chloropyll-a per land type avg'd over entire cell 
     REAL(fp), POINTER :: XCHLR00   (:,:) 
     REAL(fp), POINTER :: XCHLR01   (:,:)
     REAL(fp), POINTER :: XCHLR02   (:,:)
     REAL(fp), POINTER :: XCHLR03   (:,:)
     REAL(fp), POINTER :: XCHLR04   (:,:)  
     REAL(fp), POINTER :: XCHLR05   (:,:)  
     REAL(fp), POINTER :: XCHLR06   (:,:)  
     REAL(fp), POINTER :: XCHLR07   (:,:)  
     REAL(fp), POINTER :: XCHLR08   (:,:)  
     REAL(fp), POINTER :: XCHLR09   (:,:)  
     REAL(fp), POINTER :: XCHLR10   (:,:)  
     REAL(fp), POINTER :: XCHLR11   (:,:)  
     REAL(fp), POINTER :: XCHLR12   (:,:)  
     REAL(fp), POINTER :: XCHLR13   (:,:)  
     REAL(fp), POINTER :: XCHLR14   (:,:)  
     REAL(fp), POINTER :: XCHLR15   (:,:)  
     REAL(fp), POINTER :: XCHLR16   (:,:)  
     REAL(fp), POINTER :: XCHLR17   (:,:)  
     REAL(fp), POINTER :: XCHLR18   (:,:)  
     REAL(fp), POINTER :: XCHLR19   (:,:)  
     REAL(fp), POINTER :: XCHLR20   (:,:)  
     REAL(fp), POINTER :: XCHLR21   (:,:)  
     REAL(fp), POINTER :: XCHLR22   (:,:)  
     REAL(fp), POINTER :: XCHLR23   (:,:)  
     REAL(fp), POINTER :: XCHLR24   (:,:)  
     REAL(fp), POINTER :: XCHLR25   (:,:)  
     REAL(fp), POINTER :: XCHLR26   (:,:)  
     REAL(fp), POINTER :: XCHLR27   (:,:)  
     REAL(fp), POINTER :: XCHLR28   (:,:)  
     REAL(fp), POINTER :: XCHLR29   (:,:)  
     REAL(fp), POINTER :: XCHLR30   (:,:)  
     REAL(fp), POINTER :: XCHLR31   (:,:)  
     REAL(fp), POINTER :: XCHLR32   (:,:)  
     REAL(fp), POINTER :: XCHLR33   (:,:)  
     REAL(fp), POINTER :: XCHLR34   (:,:)  
     REAL(fp), POINTER :: XCHLR35   (:,:)  
     REAL(fp), POINTER :: XCHLR36   (:,:)  
     REAL(fp), POINTER :: XCHLR37   (:,:)  
     REAL(fp), POINTER :: XCHLR38   (:,:)  
     REAL(fp), POINTER :: XCHLR39   (:,:)  
     REAL(fp), POINTER :: XCHLR40   (:,:)  
     REAL(fp), POINTER :: XCHLR41   (:,:)  
     REAL(fp), POINTER :: XCHLR42   (:,:)  
     REAL(fp), POINTER :: XCHLR43   (:,:)  
     REAL(fp), POINTER :: XCHLR44   (:,:)  
     REAL(fp), POINTER :: XCHLR45   (:,:)  
     REAL(fp), POINTER :: XCHLR46   (:,:)  
     REAL(fp), POINTER :: XCHLR47   (:,:)  
     REAL(fp), POINTER :: XCHLR48   (:,:)  
     REAL(fp), POINTER :: XCHLR49   (:,:)  
     REAL(fp), POINTER :: XCHLR50   (:,:)  
     REAL(fp), POINTER :: XCHLR51   (:,:)  
     REAL(fp), POINTER :: XCHLR52   (:,:)  
     REAL(fp), POINTER :: XCHLR53   (:,:)  
     REAL(fp), POINTER :: XCHLR54   (:,:)  
     REAL(fp), POINTER :: XCHLR55   (:,:)  
     REAL(fp), POINTER :: XCHLR56   (:,:)  
     REAL(fp), POINTER :: XCHLR57   (:,:)  
     REAL(fp), POINTER :: XCHLR58   (:,:)  
     REAL(fp), POINTER :: XCHLR59   (:,:)  
     REAL(fp), POINTER :: XCHLR60   (:,:)  
     REAL(fp), POINTER :: XCHLR61   (:,:)  
     REAL(fp), POINTER :: XCHLR62   (:,:)  
     REAL(fp), POINTER :: XCHLR63   (:,:)  
     REAL(fp), POINTER :: XCHLR64   (:,:)  
     REAL(fp), POINTER :: XCHLR65   (:,:)  
     REAL(fp), POINTER :: XCHLR66   (:,:)  
     REAL(fp), POINTER :: XCHLR67   (:,:)  
     REAL(fp), POINTER :: XCHLR68   (:,:)  
     REAL(fp), POINTER :: XCHLR69   (:,:)  
     REAL(fp), POINTER :: XCHLR70   (:,:)  
     REAL(fp), POINTER :: XCHLR71   (:,:)  
     REAL(fp), POINTER :: XCHLR72   (:,:)  
     REAL(fp), POINTER :: XCHLR73   (:,:)  
     REAL(fp), POINTER :: XCHLR74   (:,:)  
...
!             Remove from state_met in the future!!! (ewl, 10/12/16)
    ! OLSON land map (fraction per type)
    ALLOCATE( State_Met%OLSON00    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%OLSON00   = 0.0_fp
    ...
    ! LAI per type avg'd over entire cell
    ALLOCATE( State_Met%XLAI00    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI00   = 0.0_fp

    ALLOCATE( State_Met%XLAI01    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI01   = 0.0_fp

    ALLOCATE( State_Met%XLAI02    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI02   = 0.0_fp

    ALLOCATE( State_Met%XLAI03    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI03   = 0.0_fp

    ALLOCATE( State_Met%XLAI04    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI04   = 0.0_fp

    ALLOCATE( State_Met%XLAI05    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI05   = 0.0_fp

    ALLOCATE( State_Met%XLAI06    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI06   = 0.0_fp

    ALLOCATE( State_Met%XLAI07    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI07   = 0.0_fp

    ALLOCATE( State_Met%XLAI08    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI08   = 0.0_fp

    ALLOCATE( State_Met%XLAI09    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI09   = 0.0_fp

    ALLOCATE( State_Met%XLAI10    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI10   = 0.0_fp

    ALLOCATE( State_Met%XLAI11    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI11   = 0.0_fp

    ALLOCATE( State_Met%XLAI12    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI12   = 0.0_fp

    ALLOCATE( State_Met%XLAI13    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI13   = 0.0_fp

    ALLOCATE( State_Met%XLAI14    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI14  = 0.0_fp

    ALLOCATE( State_Met%XLAI15    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI15  = 0.0_fp

    ALLOCATE( State_Met%XLAI16    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI16  = 0.0_fp

    ALLOCATE( State_Met%XLAI17    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI17  = 0.0_fp

    ALLOCATE( State_Met%XLAI18    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI18  = 0.0_fp

    ALLOCATE( State_Met%XLAI19    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI19   = 0.0_fp

    ALLOCATE( State_Met%XLAI20    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI20  = 0.0_fp

    ALLOCATE( State_Met%XLAI21    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI21  = 0.0_fp

    ALLOCATE( State_Met%XLAI22    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI22  = 0.0_fp

    ALLOCATE( State_Met%XLAI23    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI23  = 0.0_fp

    ALLOCATE( State_Met%XLAI24    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI24  = 0.0_fp

    ALLOCATE( State_Met%XLAI25    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI25  = 0.0_fp

    ALLOCATE( State_Met%XLAI26    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI26  = 0.0_fp

    ALLOCATE( State_Met%XLAI27    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI27  = 0.0_fp

    ALLOCATE( State_Met%XLAI28    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI28   = 0.0_fp

    ALLOCATE( State_Met%XLAI29    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI29   = 0.0_fp

    ALLOCATE( State_Met%XLAI30    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI30   = 0.0_fp

    ALLOCATE( State_Met%XLAI31    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI31   = 0.0_fp

    ALLOCATE( State_Met%XLAI32    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI32   = 0.0_fp

    ALLOCATE( State_Met%XLAI33    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI33   = 0.0_fp

    ALLOCATE( State_Met%XLAI34    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI34  = 0.0_fp

    ALLOCATE( State_Met%XLAI35    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI35  = 0.0_fp

    ALLOCATE( State_Met%XLAI36    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI36  = 0.0_fp

    ALLOCATE( State_Met%XLAI37    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI37  = 0.0_fp

    ALLOCATE( State_Met%XLAI38    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI38  = 0.0_fp

    ALLOCATE( State_Met%XLAI39    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI39  = 0.0_fp

    ALLOCATE( State_Met%XLAI40    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI40  = 0.0_fp

    ALLOCATE( State_Met%XLAI41    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI41  = 0.0_fp

    ALLOCATE( State_Met%XLAI42    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI42  = 0.0_fp

    ALLOCATE( State_Met%XLAI43    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI43  = 0.0_fp

    ALLOCATE( State_Met%XLAI44    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI44  = 0.0_fp

    ALLOCATE( State_Met%XLAI45    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI45  = 0.0_fp

    ALLOCATE( State_Met%XLAI46    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI46  = 0.0_fp

    ALLOCATE( State_Met%XLAI47    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI47  = 0.0_fp

    ALLOCATE( State_Met%XLAI48    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI48  = 0.0_fp

    ALLOCATE( State_Met%XLAI49    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI49  = 0.0_fp

    ALLOCATE( State_Met%XLAI50    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI50  = 0.0_fp

    ALLOCATE( State_Met%XLAI51    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI51  = 0.0_fp

    ALLOCATE( State_Met%XLAI52    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI52  = 0.0_fp

    ALLOCATE( State_Met%XLAI53    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI53  = 0.0_fp

    ALLOCATE( State_Met%XLAI54    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI54  = 0.0_fp

    ALLOCATE( State_Met%XLAI55    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI55  = 0.0_fp

    ALLOCATE( State_Met%XLAI56    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI56  = 0.0_fp

    ALLOCATE( State_Met%XLAI57    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI57  = 0.0_fp

    ALLOCATE( State_Met%XLAI58    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI58  = 0.0_fp

    ALLOCATE( State_Met%XLAI59    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI59  = 0.0_fp

    ALLOCATE( State_Met%XLAI60    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI60   = 0.0_fp

    ALLOCATE( State_Met%XLAI61    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI61   = 0.0_fp

    ALLOCATE( State_Met%XLAI62    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI62   = 0.0_fp

    ALLOCATE( State_Met%XLAI63    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI63   = 0.0_fp

    ALLOCATE( State_Met%XLAI64    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI64   = 0.0_fp

    ALLOCATE( State_Met%XLAI65    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI65   = 0.0_fp

    ALLOCATE( State_Met%XLAI66    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI66   = 0.0_fp

    ALLOCATE( State_Met%XLAI67    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI67    = 0.0_fp

    ALLOCATE( State_Met%XLAI68    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI68   = 0.0_fp

    ALLOCATE( State_Met%XLAI69    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI69   = 0.0_fp

    ALLOCATE( State_Met%XLAI70    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI70   = 0.0_fp

    ALLOCATE( State_Met%XLAI71    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI71   = 0.0_fp

    ALLOCATE( State_Met%XLAI72    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI72   = 0.0_fp

    ALLOCATE( State_Met%XLAI73    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XLAI73   = 0.0_fp

    ! CHLR per type avg'd over entire cell
    ALLOCATE( State_Met%XCHLR00    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR00   = 0.0_fp

    ALLOCATE( State_Met%XCHLR01    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR01   = 0.0_fp

    ALLOCATE( State_Met%XCHLR02    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR02   = 0.0_fp

    ALLOCATE( State_Met%XCHLR03    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR03   = 0.0_fp

    ALLOCATE( State_Met%XCHLR04    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR04   = 0.0_fp

    ALLOCATE( State_Met%XCHLR05    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR05   = 0.0_fp

    ALLOCATE( State_Met%XCHLR06    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR06   = 0.0_fp

    ALLOCATE( State_Met%XCHLR07    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR07   = 0.0_fp

    ALLOCATE( State_Met%XCHLR08    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR08   = 0.0_fp

    ALLOCATE( State_Met%XCHLR09    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR09   = 0.0_fp

    ALLOCATE( State_Met%XCHLR10    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR10   = 0.0_fp

    ALLOCATE( State_Met%XCHLR11    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR11   = 0.0_fp

    ALLOCATE( State_Met%XCHLR12    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR12   = 0.0_fp

    ALLOCATE( State_Met%XCHLR13    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR13   = 0.0_fp

    ALLOCATE( State_Met%XCHLR14    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR14  = 0.0_fp

    ALLOCATE( State_Met%XCHLR15    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR15  = 0.0_fp

    ALLOCATE( State_Met%XCHLR16    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR16  = 0.0_fp

    ALLOCATE( State_Met%XCHLR17    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR17  = 0.0_fp

    ALLOCATE( State_Met%XCHLR18    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR18  = 0.0_fp

    ALLOCATE( State_Met%XCHLR19    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR19   = 0.0_fp

    ALLOCATE( State_Met%XCHLR20    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR20  = 0.0_fp

    ALLOCATE( State_Met%XCHLR21    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR21  = 0.0_fp

    ALLOCATE( State_Met%XCHLR22    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR22  = 0.0_fp

    ALLOCATE( State_Met%XCHLR23    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR23  = 0.0_fp

    ALLOCATE( State_Met%XCHLR24    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR24  = 0.0_fp

    ALLOCATE( State_Met%XCHLR25    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR25  = 0.0_fp

    ALLOCATE( State_Met%XCHLR26    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR26  = 0.0_fp

    ALLOCATE( State_Met%XCHLR27    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR27  = 0.0_fp

    ALLOCATE( State_Met%XCHLR28    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR28   = 0.0_fp

    ALLOCATE( State_Met%XCHLR29    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR29   = 0.0_fp

    ALLOCATE( State_Met%XCHLR30    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR30   = 0.0_fp

    ALLOCATE( State_Met%XCHLR31    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR31   = 0.0_fp

    ALLOCATE( State_Met%XCHLR32    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR32   = 0.0_fp

    ALLOCATE( State_Met%XCHLR33    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR33   = 0.0_fp

    ALLOCATE( State_Met%XCHLR34    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR34  = 0.0_fp

    ALLOCATE( State_Met%XCHLR35    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR35  = 0.0_fp

    ALLOCATE( State_Met%XCHLR36    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR36  = 0.0_fp

    ALLOCATE( State_Met%XCHLR37    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR37  = 0.0_fp

    ALLOCATE( State_Met%XCHLR38    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR38  = 0.0_fp

    ALLOCATE( State_Met%XCHLR39    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR39  = 0.0_fp

    ALLOCATE( State_Met%XCHLR40    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR40  = 0.0_fp

    ALLOCATE( State_Met%XCHLR41    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR41  = 0.0_fp

    ALLOCATE( State_Met%XCHLR42    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR42  = 0.0_fp

    ALLOCATE( State_Met%XCHLR43    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR43  = 0.0_fp

    ALLOCATE( State_Met%XCHLR44    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR44  = 0.0_fp

    ALLOCATE( State_Met%XCHLR45    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR45  = 0.0_fp

    ALLOCATE( State_Met%XCHLR46    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR46  = 0.0_fp

    ALLOCATE( State_Met%XCHLR47    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR47  = 0.0_fp

    ALLOCATE( State_Met%XCHLR48    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR48  = 0.0_fp

    ALLOCATE( State_Met%XCHLR49    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR49  = 0.0_fp

    ALLOCATE( State_Met%XCHLR50    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR50  = 0.0_fp

    ALLOCATE( State_Met%XCHLR51    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR51  = 0.0_fp

    ALLOCATE( State_Met%XCHLR52    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR52  = 0.0_fp

    ALLOCATE( State_Met%XCHLR53    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR53  = 0.0_fp

    ALLOCATE( State_Met%XCHLR54    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR54  = 0.0_fp

    ALLOCATE( State_Met%XCHLR55    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR55  = 0.0_fp

    ALLOCATE( State_Met%XCHLR56    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR56  = 0.0_fp

    ALLOCATE( State_Met%XCHLR57    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR57  = 0.0_fp

    ALLOCATE( State_Met%XCHLR58    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR58  = 0.0_fp

    ALLOCATE( State_Met%XCHLR59    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR59  = 0.0_fp

    ALLOCATE( State_Met%XCHLR60    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR60   = 0.0_fp

    ALLOCATE( State_Met%XCHLR61    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR61   = 0.0_fp

    ALLOCATE( State_Met%XCHLR62    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR62   = 0.0_fp

    ALLOCATE( State_Met%XCHLR63    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR63   = 0.0_fp

    ALLOCATE( State_Met%XCHLR64    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR64   = 0.0_fp

    ALLOCATE( State_Met%XCHLR65    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR65   = 0.0_fp

    ALLOCATE( State_Met%XCHLR66    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR66   = 0.0_fp

    ALLOCATE( State_Met%XCHLR67    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR67    = 0.0_fp

    ALLOCATE( State_Met%XCHLR68    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR68   = 0.0_fp

    ALLOCATE( State_Met%XCHLR69    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR69   = 0.0_fp

    ALLOCATE( State_Met%XCHLR70    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR70   = 0.0_fp

    ALLOCATE( State_Met%XCHLR71    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR71   = 0.0_fp

    ALLOCATE( State_Met%XCHLR72    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR72   = 0.0_fp

    ALLOCATE( State_Met%XCHLR73    ( IM, JM        ), STAT=RC )        
    IF ( RC /= GIGC_SUCCESS ) RETURN
    State_Met%XCHLR73   = 0.0_fp
...
! TEMPORARY (ewl, 10/12/16) - for GCHP
    ...
    IF ( ASSOCIATED( State_Met%OLSON00    )) DEALLOCATE( State_Met%OLSON00    )
    ...
    ! LAI per type avg'd over entire cell
    IF ( ASSOCIATED( State_Met%XLAI00    )) DEALLOCATE( State_Met%XLAI00    )
    IF ( ASSOCIATED( State_Met%XLAI01    )) DEALLOCATE( State_Met%XLAI01    )
    IF ( ASSOCIATED( State_Met%XLAI02    )) DEALLOCATE( State_Met%XLAI02    )
    IF ( ASSOCIATED( State_Met%XLAI03    )) DEALLOCATE( State_Met%XLAI03    )
    IF ( ASSOCIATED( State_Met%XLAI04    )) DEALLOCATE( State_Met%XLAI04    )
    IF ( ASSOCIATED( State_Met%XLAI05    )) DEALLOCATE( State_Met%XLAI05    )
    IF ( ASSOCIATED( State_Met%XLAI06    )) DEALLOCATE( State_Met%XLAI06    )
    IF ( ASSOCIATED( State_Met%XLAI07    )) DEALLOCATE( State_Met%XLAI07    )
    IF ( ASSOCIATED( State_Met%XLAI08    )) DEALLOCATE( State_Met%XLAI08    )
    IF ( ASSOCIATED( State_Met%XLAI09    )) DEALLOCATE( State_Met%XLAI09    )
    IF ( ASSOCIATED( State_Met%XLAI10    )) DEALLOCATE( State_Met%XLAI10    )
    IF ( ASSOCIATED( State_Met%XLAI11    )) DEALLOCATE( State_Met%XLAI11    )
    IF ( ASSOCIATED( State_Met%XLAI12    )) DEALLOCATE( State_Met%XLAI12    )
    IF ( ASSOCIATED( State_Met%XLAI13    )) DEALLOCATE( State_Met%XLAI13    )
    IF ( ASSOCIATED( State_Met%XLAI14    )) DEALLOCATE( State_Met%XLAI14    )
    IF ( ASSOCIATED( State_Met%XLAI15    )) DEALLOCATE( State_Met%XLAI15    )
    IF ( ASSOCIATED( State_Met%XLAI16    )) DEALLOCATE( State_Met%XLAI16    )
    IF ( ASSOCIATED( State_Met%XLAI17    )) DEALLOCATE( State_Met%XLAI17    )
    IF ( ASSOCIATED( State_Met%XLAI18    )) DEALLOCATE( State_Met%XLAI18    )
    IF ( ASSOCIATED( State_Met%XLAI19    )) DEALLOCATE( State_Met%XLAI19    )
    IF ( ASSOCIATED( State_Met%XLAI20    )) DEALLOCATE( State_Met%XLAI20    )
    IF ( ASSOCIATED( State_Met%XLAI21    )) DEALLOCATE( State_Met%XLAI21    )
    IF ( ASSOCIATED( State_Met%XLAI22    )) DEALLOCATE( State_Met%XLAI22    )
    IF ( ASSOCIATED( State_Met%XLAI23    )) DEALLOCATE( State_Met%XLAI23    )
    IF ( ASSOCIATED( State_Met%XLAI24    )) DEALLOCATE( State_Met%XLAI24    )
    IF ( ASSOCIATED( State_Met%XLAI25    )) DEALLOCATE( State_Met%XLAI25    )
    IF ( ASSOCIATED( State_Met%XLAI26    )) DEALLOCATE( State_Met%XLAI26    )
    IF ( ASSOCIATED( State_Met%XLAI27    )) DEALLOCATE( State_Met%XLAI27    )
    IF ( ASSOCIATED( State_Met%XLAI28    )) DEALLOCATE( State_Met%XLAI28    )
    IF ( ASSOCIATED( State_Met%XLAI29    )) DEALLOCATE( State_Met%XLAI29    )
    IF ( ASSOCIATED( State_Met%XLAI30    )) DEALLOCATE( State_Met%XLAI30    )
    IF ( ASSOCIATED( State_Met%XLAI31    )) DEALLOCATE( State_Met%XLAI31    )
    IF ( ASSOCIATED( State_Met%XLAI32    )) DEALLOCATE( State_Met%XLAI32    )
    IF ( ASSOCIATED( State_Met%XLAI33    )) DEALLOCATE( State_Met%XLAI33    )
    IF ( ASSOCIATED( State_Met%XLAI34    )) DEALLOCATE( State_Met%XLAI34    )
    IF ( ASSOCIATED( State_Met%XLAI35    )) DEALLOCATE( State_Met%XLAI35    )
    IF ( ASSOCIATED( State_Met%XLAI36    )) DEALLOCATE( State_Met%XLAI36    )
    IF ( ASSOCIATED( State_Met%XLAI37    )) DEALLOCATE( State_Met%XLAI37    )
    IF ( ASSOCIATED( State_Met%XLAI38    )) DEALLOCATE( State_Met%XLAI38    )
    IF ( ASSOCIATED( State_Met%XLAI39    )) DEALLOCATE( State_Met%XLAI39    )
    IF ( ASSOCIATED( State_Met%XLAI40    )) DEALLOCATE( State_Met%XLAI40    )
    IF ( ASSOCIATED( State_Met%XLAI41    )) DEALLOCATE( State_Met%XLAI41    )
    IF ( ASSOCIATED( State_Met%XLAI42    )) DEALLOCATE( State_Met%XLAI42    )
    IF ( ASSOCIATED( State_Met%XLAI43    )) DEALLOCATE( State_Met%XLAI43    )
    IF ( ASSOCIATED( State_Met%XLAI44    )) DEALLOCATE( State_Met%XLAI44    )
    IF ( ASSOCIATED( State_Met%XLAI45    )) DEALLOCATE( State_Met%XLAI45    )
    IF ( ASSOCIATED( State_Met%XLAI46    )) DEALLOCATE( State_Met%XLAI46    )
    IF ( ASSOCIATED( State_Met%XLAI47    )) DEALLOCATE( State_Met%XLAI47    )
    IF ( ASSOCIATED( State_Met%XLAI48    )) DEALLOCATE( State_Met%XLAI48    )
    IF ( ASSOCIATED( State_Met%XLAI49    )) DEALLOCATE( State_Met%XLAI49    )
    IF ( ASSOCIATED( State_Met%XLAI50    )) DEALLOCATE( State_Met%XLAI50    )
    IF ( ASSOCIATED( State_Met%XLAI51    )) DEALLOCATE( State_Met%XLAI51    )
    IF ( ASSOCIATED( State_Met%XLAI52    )) DEALLOCATE( State_Met%XLAI52    )
    IF ( ASSOCIATED( State_Met%XLAI53    )) DEALLOCATE( State_Met%XLAI53    )
    IF ( ASSOCIATED( State_Met%XLAI54    )) DEALLOCATE( State_Met%XLAI54    )
    IF ( ASSOCIATED( State_Met%XLAI55    )) DEALLOCATE( State_Met%XLAI55    )
    IF ( ASSOCIATED( State_Met%XLAI56    )) DEALLOCATE( State_Met%XLAI56    )
    IF ( ASSOCIATED( State_Met%XLAI57    )) DEALLOCATE( State_Met%XLAI57    )
    IF ( ASSOCIATED( State_Met%XLAI58    )) DEALLOCATE( State_Met%XLAI58    )
    IF ( ASSOCIATED( State_Met%XLAI59    )) DEALLOCATE( State_Met%XLAI59    )
    IF ( ASSOCIATED( State_Met%XLAI60    )) DEALLOCATE( State_Met%XLAI60    )
    IF ( ASSOCIATED( State_Met%XLAI61    )) DEALLOCATE( State_Met%XLAI61    )
    IF ( ASSOCIATED( State_Met%XLAI62    )) DEALLOCATE( State_Met%XLAI62    )
    IF ( ASSOCIATED( State_Met%XLAI63    )) DEALLOCATE( State_Met%XLAI63    )
    IF ( ASSOCIATED( State_Met%XLAI64    )) DEALLOCATE( State_Met%XLAI64    )
    IF ( ASSOCIATED( State_Met%XLAI65    )) DEALLOCATE( State_Met%XLAI65    )
    IF ( ASSOCIATED( State_Met%XLAI66    )) DEALLOCATE( State_Met%XLAI66    )
    IF ( ASSOCIATED( State_Met%XLAI67    )) DEALLOCATE( State_Met%XLAI67    )
    IF ( ASSOCIATED( State_Met%XLAI68    )) DEALLOCATE( State_Met%XLAI68    )
    IF ( ASSOCIATED( State_Met%XLAI69    )) DEALLOCATE( State_Met%XLAI69    )
    IF ( ASSOCIATED( State_Met%XLAI70    )) DEALLOCATE( State_Met%XLAI70    )
    IF ( ASSOCIATED( State_Met%XLAI71    )) DEALLOCATE( State_Met%XLAI71    )
    IF ( ASSOCIATED( State_Met%XLAI72    )) DEALLOCATE( State_Met%XLAI72    )
    IF ( ASSOCIATED( State_Met%XLAI73    )) DEALLOCATE( State_Met%XLAI73    )
    ! CHLR per type avg'd over entire cell
    IF ( ASSOCIATED( State_Met%XCHLR00    )) DEALLOCATE( State_Met%XCHLR00    )
    IF ( ASSOCIATED( State_Met%XCHLR01    )) DEALLOCATE( State_Met%XCHLR01    )
    IF ( ASSOCIATED( State_Met%XCHLR02    )) DEALLOCATE( State_Met%XCHLR02    )
    IF ( ASSOCIATED( State_Met%XCHLR03    )) DEALLOCATE( State_Met%XCHLR03    )
    IF ( ASSOCIATED( State_Met%XCHLR04    )) DEALLOCATE( State_Met%XCHLR04    )
    IF ( ASSOCIATED( State_Met%XCHLR05    )) DEALLOCATE( State_Met%XCHLR05    )
    IF ( ASSOCIATED( State_Met%XCHLR06    )) DEALLOCATE( State_Met%XCHLR06    )
    IF ( ASSOCIATED( State_Met%XCHLR07    )) DEALLOCATE( State_Met%XCHLR07    )
    IF ( ASSOCIATED( State_Met%XCHLR08    )) DEALLOCATE( State_Met%XCHLR08    )
    IF ( ASSOCIATED( State_Met%XCHLR09    )) DEALLOCATE( State_Met%XCHLR09    )
    IF ( ASSOCIATED( State_Met%XCHLR10    )) DEALLOCATE( State_Met%XCHLR10    )
    IF ( ASSOCIATED( State_Met%XCHLR11    )) DEALLOCATE( State_Met%XCHLR11    )
    IF ( ASSOCIATED( State_Met%XCHLR12    )) DEALLOCATE( State_Met%XCHLR12    )
    IF ( ASSOCIATED( State_Met%XCHLR13    )) DEALLOCATE( State_Met%XCHLR13    )
    IF ( ASSOCIATED( State_Met%XCHLR14    )) DEALLOCATE( State_Met%XCHLR14    )
    IF ( ASSOCIATED( State_Met%XCHLR15    )) DEALLOCATE( State_Met%XCHLR15    )
    IF ( ASSOCIATED( State_Met%XCHLR16    )) DEALLOCATE( State_Met%XCHLR16    )
    IF ( ASSOCIATED( State_Met%XCHLR17    )) DEALLOCATE( State_Met%XCHLR17    )
    IF ( ASSOCIATED( State_Met%XCHLR18    )) DEALLOCATE( State_Met%XCHLR18    )
    IF ( ASSOCIATED( State_Met%XCHLR19    )) DEALLOCATE( State_Met%XCHLR19    )
    IF ( ASSOCIATED( State_Met%XCHLR20    )) DEALLOCATE( State_Met%XCHLR20    )
    IF ( ASSOCIATED( State_Met%XCHLR21    )) DEALLOCATE( State_Met%XCHLR21    )
    IF ( ASSOCIATED( State_Met%XCHLR22    )) DEALLOCATE( State_Met%XCHLR22    )
    IF ( ASSOCIATED( State_Met%XCHLR23    )) DEALLOCATE( State_Met%XCHLR23    )
    IF ( ASSOCIATED( State_Met%XCHLR24    )) DEALLOCATE( State_Met%XCHLR24    )
    IF ( ASSOCIATED( State_Met%XCHLR25    )) DEALLOCATE( State_Met%XCHLR25    )
    IF ( ASSOCIATED( State_Met%XCHLR26    )) DEALLOCATE( State_Met%XCHLR26    )
    IF ( ASSOCIATED( State_Met%XCHLR27    )) DEALLOCATE( State_Met%XCHLR27    )
    IF ( ASSOCIATED( State_Met%XCHLR28    )) DEALLOCATE( State_Met%XCHLR28    )
    IF ( ASSOCIATED( State_Met%XCHLR29    )) DEALLOCATE( State_Met%XCHLR29    )
    IF ( ASSOCIATED( State_Met%XCHLR30    )) DEALLOCATE( State_Met%XCHLR30    )
    IF ( ASSOCIATED( State_Met%XCHLR31    )) DEALLOCATE( State_Met%XCHLR31    )
    IF ( ASSOCIATED( State_Met%XCHLR32    )) DEALLOCATE( State_Met%XCHLR32    )
    IF ( ASSOCIATED( State_Met%XCHLR33    )) DEALLOCATE( State_Met%XCHLR33    )
    IF ( ASSOCIATED( State_Met%XCHLR34    )) DEALLOCATE( State_Met%XCHLR34    )
    IF ( ASSOCIATED( State_Met%XCHLR35    )) DEALLOCATE( State_Met%XCHLR35    )
    IF ( ASSOCIATED( State_Met%XCHLR36    )) DEALLOCATE( State_Met%XCHLR36    )
    IF ( ASSOCIATED( State_Met%XCHLR37    )) DEALLOCATE( State_Met%XCHLR37    )
    IF ( ASSOCIATED( State_Met%XCHLR38    )) DEALLOCATE( State_Met%XCHLR38    )
    IF ( ASSOCIATED( State_Met%XCHLR39    )) DEALLOCATE( State_Met%XCHLR39    )
    IF ( ASSOCIATED( State_Met%XCHLR40    )) DEALLOCATE( State_Met%XCHLR40    )
    IF ( ASSOCIATED( State_Met%XCHLR41    )) DEALLOCATE( State_Met%XCHLR41    )
    IF ( ASSOCIATED( State_Met%XCHLR42    )) DEALLOCATE( State_Met%XCHLR42    )
    IF ( ASSOCIATED( State_Met%XCHLR43    )) DEALLOCATE( State_Met%XCHLR43    )
    IF ( ASSOCIATED( State_Met%XCHLR44    )) DEALLOCATE( State_Met%XCHLR44    )
    IF ( ASSOCIATED( State_Met%XCHLR45    )) DEALLOCATE( State_Met%XCHLR45    )
    IF ( ASSOCIATED( State_Met%XCHLR46    )) DEALLOCATE( State_Met%XCHLR46    )
    IF ( ASSOCIATED( State_Met%XCHLR47    )) DEALLOCATE( State_Met%XCHLR47    )
    IF ( ASSOCIATED( State_Met%XCHLR48    )) DEALLOCATE( State_Met%XCHLR48    )
    IF ( ASSOCIATED( State_Met%XCHLR49    )) DEALLOCATE( State_Met%XCHLR49    )
    IF ( ASSOCIATED( State_Met%XCHLR50    )) DEALLOCATE( State_Met%XCHLR50    )
    IF ( ASSOCIATED( State_Met%XCHLR51    )) DEALLOCATE( State_Met%XCHLR51    )
    IF ( ASSOCIATED( State_Met%XCHLR52    )) DEALLOCATE( State_Met%XCHLR52    )
    IF ( ASSOCIATED( State_Met%XCHLR53    )) DEALLOCATE( State_Met%XCHLR53    )
    IF ( ASSOCIATED( State_Met%XCHLR54    )) DEALLOCATE( State_Met%XCHLR54    )
    IF ( ASSOCIATED( State_Met%XCHLR55    )) DEALLOCATE( State_Met%XCHLR55    )
    IF ( ASSOCIATED( State_Met%XCHLR56    )) DEALLOCATE( State_Met%XCHLR56    )
    IF ( ASSOCIATED( State_Met%XCHLR57    )) DEALLOCATE( State_Met%XCHLR57    )
    IF ( ASSOCIATED( State_Met%XCHLR58    )) DEALLOCATE( State_Met%XCHLR58    )
    IF ( ASSOCIATED( State_Met%XCHLR59    )) DEALLOCATE( State_Met%XCHLR59    )
    IF ( ASSOCIATED( State_Met%XCHLR60    )) DEALLOCATE( State_Met%XCHLR60    )
    IF ( ASSOCIATED( State_Met%XCHLR61    )) DEALLOCATE( State_Met%XCHLR61    )
    IF ( ASSOCIATED( State_Met%XCHLR62    )) DEALLOCATE( State_Met%XCHLR62    )
    IF ( ASSOCIATED( State_Met%XCHLR63    )) DEALLOCATE( State_Met%XCHLR63    )
    IF ( ASSOCIATED( State_Met%XCHLR64    )) DEALLOCATE( State_Met%XCHLR64    )
    IF ( ASSOCIATED( State_Met%XCHLR65    )) DEALLOCATE( State_Met%XCHLR65    )
    IF ( ASSOCIATED( State_Met%XCHLR66    )) DEALLOCATE( State_Met%XCHLR66    )
    IF ( ASSOCIATED( State_Met%XCHLR67    )) DEALLOCATE( State_Met%XCHLR67    )
    IF ( ASSOCIATED( State_Met%XCHLR68    )) DEALLOCATE( State_Met%XCHLR68    )
    IF ( ASSOCIATED( State_Met%XCHLR69    )) DEALLOCATE( State_Met%XCHLR69    )
    IF ( ASSOCIATED( State_Met%XCHLR70    )) DEALLOCATE( State_Met%XCHLR70    )
    IF ( ASSOCIATED( State_Met%XCHLR71    )) DEALLOCATE( State_Met%XCHLR71    )
    IF ( ASSOCIATED( State_Met%XCHLR72    )) DEALLOCATE( State_Met%XCHLR72    )
    IF ( ASSOCIATED( State_Met%XCHLR73    )) DEALLOCATE( State_Met%XCHLR73    )
