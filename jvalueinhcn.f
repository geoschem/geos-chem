C $Id: jvalueinhcn.f,v 1.1 2003/06/30 20:26:10 bmy Exp $
      SUBROUTINE JVALUEINHCN
C
C     reads in parameters for jvalue calculation -- HCN simulation
C
...
C Standard atmosphere for air density 0-15-30-45-60N, summer.
     ...
     1     HEIGHT,SCALE
      ...
      OPEN(42, FILE='jvalue.dat',status='unknown',err=160)
...
C Get AERXCT
 ...
 120  CONTINUE
      ...
      OPEN(42, FILE='o3du.dat',status='unknown',err=160)
      READ(42,201) TITLE
      READ(42,201) TITLE
      READ(42, 203) O3DU
...
C OPEN ERROR
 160  CONTINUE
      CALL ERROR_STOP( 'Open error in "jvalue.dat"', 'jvalueinhcn.f' )
