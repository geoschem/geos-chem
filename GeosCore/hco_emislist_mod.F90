...
!BOP
!
! !ROUTINE: EmisList_Update
!
! !DESCRIPTION: Subroutine EmisList_Update makes sure that all containers
...
! !INTERFACE:
!
      SUBROUTINE EmisList_GetDataArr_3D( am_I_Root, DctName, Arr3D, &
                                         RC, TIDX )
!
! !USES:
!
...
!
      ...
      INTEGER,          INTENT(IN), OPTIONAL :: TIDX           ! time index (default=1)
!
! !REVISION HISTORY: 
...
! !INTERFACE:
!
      SUBROUTINE EmisList_GetDataArr_2D( am_I_Root, DctName, Arr2D, &
                                         RC, TIDX )
!
! !USES:
!
