...
! !LOCAL VARIABLES:
      ...
      write(IU_FILE, '(a)') 'and KPP-specific fields. All other fields are for reference. If wanting to '
      write(IU_FILE, '(a)') 'use this output for other analysis, a Python class to read these fields is '
      write(IU_FILE, '(a)') 'available by request, contact Obin Sturm (psturm@usc.edu).                 '
      write(IU_FILE, '(a)') '                                                                           '
      write(IU_FILE, '(a)') 'Generated by GEOS-Chem Model                                               '
      ...
      write(IU_File,'(a)'      ) 'All concentration units are in molecules/cc.'
      DO N=1,NSPEC
