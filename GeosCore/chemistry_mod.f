...
! 
      ...
      INTEGER                  :: N_TROP, MONTH, YEAR, WAVELENGTH
...
!         RTOL(i) = 2.d-1
!         RTOL(i) = 1.d-1
         ! skim, tighten the relative tolerance further to prevent crashing
         RTOL(i) = 5.d-2
!     Tighten the error tolerance to force convergence (skim, 02/06/11)
!         RTOL(i) = 5.d-2
         ATOL(i) = 1.d-2
      END DO
