...
!
! !DESCRIPTION: Module HCO\_STANDALONE\_MOD.F90 contains all wrapper routines 
...
!
! !DESCRIPTION: Subroutine HCO_STANDALONE_RUN runs the standalone version
...
!
      ...
      ! Error handling 
      LOC = 'HCOI_SA_INIT (hcoi_SA_mod.F90)'
...
!
      ...
      ! For error handling
      LOC = 'HCOI_SA_RUN (hcoi_gc_mod.F90)'
...
!
      ...
      ! Init
      LOC = 'HCOI_SA_FINAL (hcoi_gc_main.F90)'
...
! !IROUTINE: Read_Time 
!
! !DESCRIPTION: SUBROUTINE READ\_TIME reads the time information from file. 
!\\
!\\
! !INTERFACE:
!
