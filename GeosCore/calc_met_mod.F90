...
!
    ...
    LOGICAL             :: update_species_mixing_ratio, update_budget
...
!
    ...
    update_species_mixing_ratio = .TRUE.
    IF ( PRESENT(update_mixing_ratio) ) &
         update_species_mixing_ratio = update_mixing_ratio
    ...
    IF ( update_species_mixing_ratio ) THEN
