...
!
    ...
    DO IIWV = 1, NWVS
       ...
       DO I = 1, State_Grid%NX
          ...
          ODMDUST(I,J,L,IWV,N) = 0.75e+0_fp * &
                                 ...
                                 DUST(I,J,L,N) * QQAA(IWV,N,IDST,DRG)  / &
                                 ( MSDENS(N) * RDAA(N,IDST,DRG) * 1.0e-6_fp)
          ...
          RTSSAER(I,J,L,IWV,NAER+2+N) = SSAA(IWV,N,IDST,DRG)
          RTASYMAER(I,J,L,IWV,NAER+2+N) = ASYMAA(IWV,N,IDST,DRG)
#endif
    ...
    DO I = 1, State_Grid%NX
       ...
       ERADIUS(I,J,L,N) = RDAA(N,IDST,DRG) * 1.0e-4_fp
