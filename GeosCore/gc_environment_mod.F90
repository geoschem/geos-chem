...
!
    ...
    ALLOCATE( &
         ...
         LOCAL_MET%PHIS    (IIPAR, JJPAR), & ! Sfc geopotential height [m2/s2]
         ...
         LOCAL_MET%PRECLSC (IIPAR, JJPAR), & ! LS precip @ ground [kg/m2/s]
         LOCAL_MET%PRECSNO (IIPAR, JJPAR), & ! Snow precip [kg/m2/s]
         LOCAL_MET%PS1     (IIPAR, JJPAR), & ! Sfc press at start of step [hPa]
         LOCAL_MET%PS2     (IIPAR, JJPAR), & ! Sfc press at end   of step [hPa]
         ...
         LOCAL_MET%SNOW    (IIPAR, JJPAR), & ! Snow depth (H2O equiv) [mm H2O]
         LOCAL_MET%SST     (IIPAR, JJPAR), & ! Sea surface temperature [K]
         LOCAL_MET%TO3     (IIPAR, JJPAR), & ! Total overhead O3 column [DU]
         LOCAL_MET%TO31    (IIPAR, JJPAR), & ! Total overhead O3 column [DU]
         LOCAL_MET%TO32    (IIPAR, JJPAR), & ! Total overhead O3 column [DU]
         LOCAL_MET%TROPP   (IIPAR, JJPAR), & ! Tropopause pressure [hPa]
         LOCAL_MET%TROPP1  (IIPAR, JJPAR), & ! Tropopause pressure [hPa]
         LOCAL_MET%TROPP2  (IIPAR, JJPAR), & ! Tropopause pressure [hPa]
    ...
    ALLOCATE( &
         ...
         LOCAL_MET%AREA_M2 (IIPAR, JJPAR, LLPAR), & ! Grid box sfc area [cm2]
