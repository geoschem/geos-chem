...
100       FORMAT(F5.2,A)
    ...
    DO I = 1, State_Grid%NX
       ...
       ! Methylglyoxal
       IF ( id_SOAMG > 0 ) THEN
          ISOAAQ(I,J,L) = ISOAAQ(I,J,L) + Spc(I,J,L,id_SOAMG) / AIRVOL(I,J,L)
       ENDIF
       ...
       IF ( id_SOAME > 0 ) THEN
          ISOAAQ(I,J,L) = ISOAAQ(I,J,L) + Spc(I,J,L,id_SOAME) / AIRVOL(I,J,L)
       ENDIF
       ...
       ! SOA from ISOP+NO3
       IF ( id_ISN1OA > 0 ) THEN
          ISOAAQ(I,J,L) = ISOAAQ(I,J,L) + Spc(I,J,L,id_ISN1OA) / AIRVOL(I,J,L)
       ENDIF
...
!
    ...
    IF ( First ) THEN
       ...
       ELSE
          IF ( State_Diag%Archive_AerMassISN1OA ) THEN
             ...
             ErrMsg = 'Disabling AerMassISN1OA diagnostic. ' // &
                      'ISN1OA is not a defined species for this simulation.'
             CALL GC_Warning( ErrMsg, RC, ThisLoc )
          ENDIF
       ENDIF
       ...
       ELSE
          IF ( State_Diag%Archive_AerMassSOAME ) THEN
             ...
             ErrMsg = 'Disabling AerMassLVOCOA diagnostic.' // &
                      'SOAME is not a defined species for this simulation.'
             CALL GC_Warning( ErrMsg, RC, ThisLoc )
          ENDIF
       ENDIF
       ...
       ELSE
          IF ( State_Diag%Archive_AerMassSOAMG ) THEN
             ...
             ErrMsg = 'Disabling AerMassSOAMG diagnostic.' // &
                      'SOAMG is not a defined species for this simulation.'
             CALL GC_Warning( ErrMsg, RC, ThisLoc )
          ENDIF
       ENDIF
    ...
    DO I = 1, State_Grid%NX
       ...
       !--------------------------------------
       IF ( State_Diag%Archive_AerMassSOAMG ) THEN
          State_Diag%AerMassSOAMG(I,J,L) = SOAMG(I,J,L) * kgm3_to_ugm3
       ENDIF
