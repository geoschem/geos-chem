...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'RCO3           ','R4N1           ','ATO2           ', &
     'ISN1           ','MAO3           ','SO2            ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(35) :: SPC_NAMES_1 = (/ &
     'MGLY           ','INO2           ','RIO2           ', &
     'HC5            ','CH2O           ','MRO2           ', &
     ...
     'H2O            ','HCOOH          ','MOH            ', &
     'O2             ','RCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(125) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     ALD2 + OH --> 0.05 CH2O + 0.05 CO + 0.05 HO2 + 0.95 MCO3                                       ', &
     '    ALD2 + NO3 --> HNO3 + MCO3                                                                      ', &
     '    MCO3 + NO2 --> PAN                                                                              ', &
     '           PAN --> MCO3 + NO2                                                                       ', &
     '     NO + MCO3 --> CO2 + MO2 + NO2                                                                  ', &
     ...
     '     VRO2 + NO --> 0.12 MVKN + 0.53 GLYC + 0.35 MGLY + 0.35 CH2O + 0.35 HO2 ... etc.                ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + 0.5 CH2O + 0.5 MO2 + 0.5 CO + 0.5 MCO3 + NO2                               ', &
     '    RCHO + NO3 --> HNO3 + RCO3                                                                      ', &
     '     ACET + OH --> ATO2 + H2O                                                                       ', &
     ...
     '    ATO2 + MO2 --> 0.5 MGLY + 0.5 CH2O + 0.2 HAC + 0.3 HO2 + 0.3 MCO3 + 0.5 MOH ... etc.            ', &
     '     KO2 + MO2 --> 0.25 ROH + 0.75 CH2O + 0.5 ALD2 + 0.25 MEK + 0.5 HO2 ... etc.                    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    A3O2 + HO2 --> RA3P                                                                             ', &
     '     PO2 + HO2 --> PP                                                                               ', &
     '    HO2 + MCO3 --> 0.41 MAP + 0.44 MO2 + 0.44 OH + 0.15 O3 + 0.15 ACTA ... etc.                     ', &
     '    RCO3 + HO2 --> 0.41 RP + 0.44 ETO2 + 0.44 OH + 0.15 O3 + 0.15 RCOOH ... etc.                    ', &
     '    MAO3 + HO2 --> 0.41 MAOP + 0.59 CH2O + 0.39 MO2 + 0.39 CO + 0.44 OH ... etc.                    ', &
     '     PRPE + OH --> PO2                                                                              ', &
     '     PRPE + O3 --> 0.12 CH3CHOO + 0.12 CH2OO + 0.5 CH2O + 0.5 ALD2 + 0.28 MO2 ... etc.              ', &
     '      PMN + OH --> HAC + CO + NO2                                                                   ', &
     '      PMN + O3 --> CH2O + NO3 + MCO3                                                                ', &
     ...
     '      HAC + OH --> MGLY + HO2                                                                       ', &
     '      HAC + OH --> 0.5 CO2 + 0.5 MO2 + 0.5 CO + OH + 0.5 ACTA + 0.5 HCOOH ... etc.                  ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '     MACR + O3 --> 0.211 CH2OO + 0.022 MGLYOO + 0.88 MGLY + 0.12 CH2O + 0.767 CO ... etc.           ', &
     '    ISOP + NO3 --> INO2                                                                             ', &
     '    MACR + NO3 --> MAN2                                                                             ', &
     '    MACR + NO3 --> HNO3 + MAO3                                                                      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   VRO2 + MCO3 --> 0.6 GLYC + 0.4 MGLY + 0.4 CH2O + MO2 + 0.4 HO2 + 0.6 MCO3 ... etc.               ', &
     ...
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MACR + MO2 + 0.035 MVK ... etc.          ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     ...
     '           NO3 --> NO + O2                                                                          ', &
     '          N2O5 --> NO3 + NO2                                                                        ', &
     '          ALD2 --> 0.88 MO2 + 0.88 CO + HO2 + 0.12 MCO3                                             ', &
     '          ALD2 --> CO + CH4                                                                         ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.3 HO2 + OH + 0.7 MCO3 ... etc.                ', &
