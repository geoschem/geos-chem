...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'ISOPNB         ','ISNOHOO        ','HCOOH          ', & ! index 136 - 138
     'H2O2           ','ISNOOB         ','HOCl           ', & ! index 139 - 141
     'HOBr           ','PRN1           ','MONITU         ', & ! index 142 - 144
     'GLYX           ','MACROO         ','ISOPNBO2       ', & ! index 145 - 147
     'MVKN           ','A3O2           ','ISNOOA         ', & ! index 148 - 150
     'IEPOXOO        ','PROPNN         ','MAN2           ', & ! index 151 - 153
     'PO2            ','ISOP           ','ATO2           ', & ! index 154 - 156
     'B3O2           ','MACRN          ','MAOPO2         ', & ! index 157 - 159
     'I              ','ClNO3          ','IO             ', & ! index 160 - 162
     'HNO3           ','BrO            ','ISOPNDO2       ', & ! index 163 - 165
     'OLNN           ','OLND           ','LIMO2          ', & ! index 166 - 168
     'R4N1           ','ACTA           ','RCO3           ', & ! index 169 - 171
     'CH2OO          ','PIO2           ','ISOPND         ', & ! index 172 - 174
     'KO2            ','HBr            ','GLYC           ', & ! index 175 - 177
     'HC5OO          ','VRO2           ','NMAO3          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(38) :: SPC_NAMES_2 = (/ &
     'MGLY           ','ISN1           ','HC5            ', & ! index 181 - 183
     'R4O2           ','ClO            ','MRO2           ', & ! index 184 - 186
     'ACET           ','PRPE           ','INO2           ', & ! index 187 - 189
     'HAC            ','RIO2           ','R4N2           ', & ! index 190 - 192
     'RCHO           ','HCl            ','CH2O           ', & ! index 193 - 195
     'MVK            ','MEK            ','ALD2           ', & ! index 196 - 198
     'ETO2           ','MACR           ','Br             ', & ! index 199 - 201
     'MCO3           ','NO3            ','MO2            ', & ! index 202 - 204
     'SO2            ','NO             ','CO             ', & ! index 205 - 207
     'O3             ','HO2            ','Cl             ', & ! index 208 - 210
     'OH             ','NO2            ','CH4            ', & ! index 211 - 213
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '  MACROO + H2O --> H2O2 + MACR                                                                      ', & ! index 388
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_13 = (/ &
     ...
     '  MGLYOO + H2O --> H2O2 + MGLY                                                                      ', & ! index 398
     ...
     ' CH3CHOO + H2O --> H2O2 + ALD2                                                                      ', & ! index 409
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     ...
     '     MTPA + O3 --> LOx + 0.14 PCO + 0.02 H2O2 + 0.62 KO2 + 0.65 RCHO + 0.53 MEK + 0.14 CO + 0.1 HO2 ', & ! index 434
     '     MTPO + O3 --> LOx + 0.14 PCO + 0.02 H2O2 + 0.62 KO2 + 0.65 RCHO + 0.53 MEK + 0.14 CO + 0.1 HO2 ', & ! index 435
     '    MTPA + NO3 --> 2 LOx + 0.1 OLNN + 0.9 OLND                                                      ', & ! index 436
     '    MTPO + NO3 --> 2 LOx + 0.1 OLNN + 0.9 OLND                                                      ', & ! index 437
     '     LIMO + OH --> LIMO2                                                                            ', & ! index 438
     '     LIMO + O3 --> LOx + 0.14 PCO + 0.01 HCOOH + 0.02 H2O2 + 0.42 KO2 + 0.46 PRPE + 0.04 CH2O + 0.16', & ! index 439
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_18 = (/ &
     ...
     '          ALD2 --> 0.88 PCO + 0.12 MCO3 + 0.88 MO2 + 0.88 CO + HO2                                  ', & ! index 557
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_19 = (/ &
     ...
     '          RIPA --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 HO2 + 0.985 O', & ! index 582
     '          RIPB --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 HO2 + 0.985 O', & ! index 583
     '          RIPD --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.425 MVK + 0.285 MACR + 0.985 HO2 + 0.985 O', & ! index 584
