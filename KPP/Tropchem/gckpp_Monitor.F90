...
! Time                 : Wed Oct 17 17:13:48 2018
! Working directory    : /net/home_stu/cdholmes/test/KPP/Tropchem
...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'CHBr3          ','DHDN           ','DHDC           ', & ! index 40 - 42
     'I2O2           ','MONITA         ','BENZ           ', & ! index 43 - 45
     'CH3I           ','I2O3           ','PMNN           ', & ! index 46 - 48
     'PPN            ','TOLU           ','BrNO2          ', & ! index 49 - 51
     'CH3Br          ','HI             ','IBr            ', & ! index 52 - 54
     'IEPOXD         ','INO            ','TRO2           ', & ! index 55 - 57
     'BRO2           ','IEPOXA         ','IEPOXB         ', & ! index 58 - 60
     'IONITA         ','XRO2           ','MAP            ', & ! index 61 - 63
     'ICl            ','IMAO3          ','MPN            ', & ! index 64 - 66
     'CH2Cl2         ','CHCl3          ','Cl2O2          ', & ! index 67 - 69
     'DMS            ','HNO2           ','HNO4           ', & ! index 70 - 72
     'OIO            ','RA3P           ','RB3P           ', & ! index 73 - 75
     'XYLE           ','ETP            ','CH3Cl          ', & ! index 76 - 78
     'ClNO2          ','IONO           ','ClOO           ', & ! index 79 - 81
     'OClO           ','PAN            ','RP             ', & ! index 82 - 84
     'PP             ','PRPN           ','ALK4           ', & ! index 85 - 87
     'HPALD          ','PIP            ','R4P            ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     'ATOOH          ','BrCl           ','HOI            ', & ! index 91 - 93
     'N2O5           ','DHPCARP        ','C3H8           ', & ! index 94 - 96
     'MP             ','MRP            ','HPC52O2        ', & ! index 97 - 99
     'RIPB           ','VRP            ','Br2            ', & ! index 100 - 102
     'HC187          ','Cl2            ','IAP            ', & ! index 103 - 105
     'MOBA           ','DHMOB          ','HONIT          ', & ! index 106 - 108
     'RIPA           ','RIPD           ','BrSALC         ', & ! index 109 - 111
     'ISNP           ','BrSALA         ','MAOP           ', & ! index 112 - 114
     'EOH            ','ETHLN          ','C2H6           ', & ! index 115 - 117
     'INPN           ','MTPA           ','MTPO           ', & ! index 118 - 120
     'NPMN           ','BrNO3          ','IONO2          ', & ! index 121 - 123
     'MOBAOO         ','MVKOO          ','DIBOO          ', & ! index 124 - 126
     'IPMN           ','LIMO           ','CH3CHOO        ', & ! index 127 - 129
     'I2             ','GAOO           ','MGLYOO         ', & ! index 130 - 132
     'MACRNO2        ','ROH            ','MGLOO          ', & ! index 133 - 135
     'MONITS         ','ISOPNB         ','ISNOHOO        ', & ! index 136 - 138
     'H2O2           ','HCOOH          ','ISNOOB         ', & ! index 139 - 141
     'HOBr           ','HOCl           ','PRN1           ', & ! index 142 - 144
     'MONITU         ','IEPOXOO        ','GLYX           ', & ! index 145 - 147
     'MACROO         ','ISOPNBO2       ','MVKN           ', & ! index 148 - 150
     'A3O2           ','PROPNN         ','MAN2           ', & ! index 151 - 153
     'ISNOOA         ','PO2            ','ISOP           ', & ! index 154 - 156
     'ATO2           ','B3O2           ','MACRN          ', & ! index 157 - 159
     'MAOPO2         ','I              ','ClNO3          ', & ! index 160 - 162
     'IO             ','HNO3           ','BrO            ', & ! index 163 - 165
     'ISOPNDO2       ','OLNN           ','OLND           ', & ! index 166 - 168
     'LIMO2          ','R4N1           ','ACTA           ', & ! index 169 - 171
     'RCO3           ','CH2OO          ','PIO2           ', & ! index 172 - 174
     'HBr            ','KO2            ','GLYC           ', & ! index 175 - 177
     'ISOPND         ','HC5OO          ','VRO2           ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(39) :: SPC_NAMES_2 = (/ &
     'NMAO3          ','MGLY           ','ISN1           ', & ! index 181 - 183
     'HC5            ','R4O2           ','ClO            ', & ! index 184 - 186
     'MRO2           ','ACET           ','PRPE           ', & ! index 187 - 189
     'INO2           ','HAC            ','RIO2           ', & ! index 190 - 192
     'R4N2           ','RCHO           ','HCl            ', & ! index 193 - 195
     'CH2O           ','MACR           ','MEK            ', & ! index 196 - 198
     'ALD2           ','MVK            ','SO2            ', & ! index 199 - 201
     'MCO3           ','O3             ','HO2            ', & ! index 202 - 204
     'OH             ','Br             ','MO2            ', & ! index 205 - 207
     'NO             ','NO2            ','Cl             ', & ! index 208 - 210
     'CO             ','NO3            ','ETO2           ', & ! index 211 - 213
     'CH4            ','H2             ','H2O            ', & ! index 214 - 216
     'MOH            ','O2             ','RCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(219) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     NO + ETO2 --> POx + ALD2 + HO2 + NO2                                                           ', & ! index 46
     ...
     '     R4O2 + NO --> POx + 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.14 RCHO + 0.19 MEK + 0.32 ALD2 + 0.27', & ! index 52
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    VRO2 + HO2 --> 0.1 VRP + 0.578 GLYC + 0.102 MGLY + 0.033 RCHO + 0.102 CH2O + 0.187 MEK + 0.578 M', & ! index 103
     ...
     '    MO2 + ETO2 --> 0.25 EOH + 0.75 CH2O + 0.75 ALD2 + HO2 + 0.25 MOH                                ', & ! index 110
     '     MEK + NO3 --> LOx + HNO3 + KO2                                                                 ', & ! index 111
     '    R4O2 + MO2 --> 0.25 ROH + 0.03 A3O2 + 0.09 B3O2 + 0.16 ACET + 0.07 RCHO + 0.75 CH2O + 0.35 MEK +', & ! index 112
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '    RCO3 + MO2 --> CH2O + HO2 + ETO2                                                                ', & ! index 163
     ...
     '      ETP + OH --> 0.64 ALD2 + 0.64 OH + 0.36 ETO2                                                  ', & ! index 170
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4O2 + MCO3 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.13 RCHO + 0.19 MEK + 0.32 ALD2 + 0.27 HO2 +', & ! index 207
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   MAN2 + MCO3 --> CO2 + 0.5 PCO + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 0.5 HO2 + MO2 + 0.5 NO2 + 0.5 ', & ! index 216
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MACR + 0.035 MVK + 0.8 HO2 + MO2 + 0.3 NO', & ! index 217
     ...
     '   MCO3 + ETO2 --> ALD2 + HO2 + MO2                                                                 ', & ! index 231
     '   MCO3 + ETO2 --> ACTA + ALD2                                                                      ', & ! index 232
     '   RCO3 + MCO3 --> MO2 + ETO2                                                                       ', & ! index 233
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     ...
     '     Cl + ETO2 --> POx + ClO + ALD2 + HO2                                                           ', & ! index 307
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     ...
     '     PIO2 + NO --> 0.82 POx + 0.12 MONITS + 0.07 HCOOH + 0.06 MONITU + 0.11 ACET + 0.43 RCHO + 0.23 ', & ! index 429
     ...
     '    LIMO2 + NO --> 0.78 POx + 0.22 MONITU + 0.289 PRPE + 0.058 HAC + 0.491 RCHO + 0.231 CH2O + 0.289', & ! index 441
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_15 = (/ &
     ...
     '   OLND + MCO3 --> POx + 1.24 RCHO + 0.287 CH2O + 0.464 MEK + 0.5 MO2 + NO2 + 0.5 RCOOH             ', & ! index 454
     ...
     '   OLNN + OLND --> 0.5 POx + 1.05 MONITS + 0.45 MONITU + 0.64 RCHO + 0.202 CH2O + 0.149 MEK + 0.5 HO', & ! index 458
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '          N2O5 --> LOx + 2 HNO3                                                                     ', & ! index 482
     '   BrNO3 + H2O --> HOBr + HNO3                                                                      ', & ! index 483
     '   BrNO3 + HCl --> LOx + BrCl + HNO3                                                                ', & ! index 484
     '   ClNO3 + H2O --> HOCl + HNO3                                                                      ', & ! index 485
     '   ClNO3 + HCl --> LOx + Cl2 + HNO3                                                                 ', & ! index 486
     '   ClNO3 + HBr --> LOx + BrCl + HNO3                                                                ', & ! index 487
     'BrSALA + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 488
     'BrSALC + ClNO3 --> LOx + BrCl + HNO3                                                                ', & ! index 489
     '    HOCl + HCl --> LOx + Cl2 + H2O                                                                  ', & ! index 490
     '    HOCl + HBr --> LOx + BrCl + H2O                                                                 ', & ! index 491
     '    HOBr + HBr --> LOx + Br2 + H2O                                                                  ', & ! index 492
     '    HOBr + HCl --> LOx + BrCl + H2O                                                                 ', & ! index 493
     '          HOBr --> LOx + BrCl + H2O                                                                 ', & ! index 494
     ' BrSALA + HOBr --> LOx + Br2                                                                        ', & ! index 495
     ' BrSALC + HOBr --> LOx + Br2                                                                        ', & ! index 496
     '          HOBr --> SO4H1 + LOx + HBr                                                                ', & ! index 497
     '          HOBr --> SO4H2 + LOx + HBr                                                                ', & ! index 498
     '           HCl --> O2                                                                               ', & ! index 499
     '           HCl --> O2                                                                               ', & ! index 500
     '      HBr + O3 --> HOBr                                                                             ', & ! index 501
     '   BrSALA + O3 --> HOBr                                                                             ', & ! index 502
     '   BrSALC + O3 --> HOBr                                                                             ', & ! index 503
     '           HBr --> BrSALA                                                                           ', & ! index 504
     '           HBr --> BrSALC                                                                           ', & ! index 505
     '            HI --> AERI                                                                             ', & ! index 506
     '            HI --> ISALA                                                                            ', & ! index 507
     '            HI --> ISALC                                                                            ', & ! index 508
     '           HOI --> ISALA + LOx                                                                      ', & ! index 509
     '           HOI --> ISALC + LOx                                                                      ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_17 = (/ &
     '          I2O2 --> 2 AERI + 2 LOx                                                                   ', & ! index 511
     '          I2O2 --> 2 ISALA + 2 LOx                                                                  ', & ! index 512
     '          I2O2 --> 2 ISALC + 2 LOx                                                                  ', & ! index 513
     '          I2O3 --> 2 AERI + 3 LOx                                                                   ', & ! index 514
     '          I2O3 --> 2 ISALA + 3 LOx                                                                  ', & ! index 515
     '          I2O3 --> 2 ISALC + 3 LOx                                                                  ', & ! index 516
     '          I2O4 --> 2 AERI + 4 LOx                                                                   ', & ! index 517
     '          I2O4 --> 2 ISALA + 4 LOx                                                                  ', & ! index 518
     '          I2O4 --> 2 ISALC + 4 LOx                                                                  ', & ! index 519
     '          IONO --> ISALA + LOx                                                                      ', & ! index 520
     '          IONO --> ISALC + LOx                                                                      ', & ! index 521
     '         IONO2 --> ISALA + 2 LOx                                                                    ', & ! index 522
     '         IONO2 --> ISALC + 2 LOx                                                                    ', & ! index 523
     '          IONO --> LOx + 0.15 IBr + 0.85 ICl + HNO2                                                 ', & ! index 524
     '         IONO2 --> LOx + 0.15 IBr + 0.85 ICl + HNO3                                                 ', & ! index 525
     '           HOI --> LOx + 0.15 IBr + 0.85 ICl                                                        ', & ! index 526
     '          GLYX --> SOAGX                                                                            ', & ! index 527
     '          MGLY --> SOAMG                                                                            ', & ! index 528
     '        IEPOXA --> SOAIE                                                                            ', & ! index 529
     '        IEPOXB --> SOAIE                                                                            ', & ! index 530
     '        IEPOXD --> SOAIE                                                                            ', & ! index 531
     '          IMAE --> SOAME                                                                            ', & ! index 532
     '          LVOC --> LVOCOA                                                                           ', & ! index 533
     '        ISN1OG --> ISN1OA                                                                           ', & ! index 534
     '        ISOPND --> LOx + IONITA                                                                     ', & ! index 535
     '        ISOPNB --> LOx + IONITA                                                                     ', & ! index 536
     '         MACRN --> LOx + IONITA                                                                     ', & ! index 537
     '          MVKN --> LOx + IONITA                                                                     ', & ! index 538
     '          R4N2 --> LOx + IONITA                                                                     ', & ! index 539
     '          DHDN --> IONITA                                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_18 = (/ &
     '        MONITS --> MONITA                                                                           ', & ! index 541
     '        MONITU --> MONITA                                                                           ', & ! index 542
     '         HONIT --> MONITA                                                                           ', & ! index 543
     '            O3 --> LOx + 2 OH                                                                       ', & ! index 544
     '            O3 --> LOx + HO2 + OH                                                                   ', & ! index 545
     '           NO2 --> O3 + NO                                                                          ', & ! index 546
     '          H2O2 --> 2 OH                                                                             ', & ! index 547
     '            MP --> CH2O + HO2 + OH                                                                  ', & ! index 548
     '          CH2O --> PCO + 2 HO2 + CO                                                                 ', & ! index 549
     '          CH2O --> PCO + CO + H2                                                                    ', & ! index 550
     '          HNO3 --> OH + NO2                                                                         ', & ! index 551
     '          HNO2 --> OH + NO                                                                          ', & ! index 552
     '          HNO4 --> POx + OH + NO3                                                                   ', & ! index 553
     '          HNO4 --> HO2 + NO2                                                                        ', & ! index 554
     '           NO3 --> O3 + NO2                                                                         ', & ! index 555
     '           NO3 --> 2 LOx + NO + O2                                                                  ', & ! index 556
     '          N2O5 --> NO2 + NO3                                                                        ', & ! index 557
     '          ALD2 --> 0.88 PCO + 0.12 MCO3 + HO2 + 0.88 MO2 + 0.88 CO                                  ', & ! index 558
     '          ALD2 --> PCO + CO + CH4                                                                   ', & ! index 559
     '           PAN --> 0.3 POx + 0.7 MCO3 + 0.3 MO2 + 0.7 NO2 + 0.3 NO3                                 ', & ! index 560
     '          RCHO --> PCO + HO2 + CO + ETO2                                                            ', & ! index 561
     '          ACET --> MCO3 + MO2                                                                       ', & ! index 562
     '          ACET --> PCO + 2 MO2 + CO                                                                 ', & ! index 563
     '           MEK --> 0.15 RCO3 + 0.85 MCO3 + 0.15 MO2 + 0.85 ETO2                                     ', & ! index 564
     '          GLYC --> PCO + 0.9 CH2O + 1.73 HO2 + 0.07 OH + CO + 0.1 MOH                               ', & ! index 565
     '          GLYX --> 2 PCO + 2 HO2 + 2 CO                                                             ', & ! index 566
     '          GLYX --> 2 PCO + 2 CO + H2                                                                ', & ! index 567
     '          GLYX --> PCO + CH2O + CO                                                                  ', & ! index 568
     '          MGLY --> PCO + MCO3 + HO2 + CO                                                            ', & ! index 569
     '           MVK --> PCO + PRPE + CO                                                                  ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_19 = (/ &
     '           MVK --> PCO + CH2O + MCO3 + HO2 + CO                                                     ', & ! index 571
     '           MVK --> RCO3 + MO2                                                                       ', & ! index 572
     '          MACR --> PCO + CH2O + MCO3 + HO2 + CO                                                     ', & ! index 573
     '           HAC --> CH2O + MCO3 + HO2                                                                ', & ! index 574
     '          INPN --> RCHO + HO2 + OH + NO2                                                            ', & ! index 575
     '          PRPN --> RCHO + HO2 + OH + NO2                                                            ', & ! index 576
     '           ETP --> ALD2 + HO2 + OH                                                                  ', & ! index 577
     '          RA3P --> RCHO + HO2 + OH                                                                  ', & ! index 578
     '          RB3P --> ACET + HO2 + OH                                                                  ', & ! index 579
     '           R4P --> RCHO + HO2 + OH                                                                  ', & ! index 580
     '            PP --> CH2O + ALD2 + HO2 + OH                                                           ', & ! index 581
     '            RP --> ALD2 + HO2 + OH                                                                  ', & ! index 582
     '          RIPA --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + 0.985 HO2 + 0.985 O', & ! index 583
     '          RIPB --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + 0.985 HO2 + 0.985 O', & ! index 584
     '          RIPD --> 0.005 LVOC + 0.275 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + 0.985 HO2 + 0.985 O', & ! index 585
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + HO2 + OH + 0.67 CO + 0.19 H2       ', & ! index 586
     '          ISNP --> RCHO + HO2 + OH + NO2                                                            ', & ! index 587
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.7 MCO3 + 0.3 HO2 + OH                         ', & ! index 588
     '           MRP --> 0.5 PCO + HAC + 0.5 CH2O + HO2 + OH + 0.5 CO                                     ', & ! index 589
     '          MAOP --> CH2O + MCO3 + OH                                                                 ', & ! index 590
     '          R4N2 --> 0.05 A3O2 + 0.18 B3O2 + 0.32 ACET + 0.13 RCHO + 0.19 MEK + 0.32 ALD2 + 0.27 HO2 +', & ! index 591
     '           MAP --> OH + MO2                                                                         ', & ! index 592
     '         MACRN --> 0.5 PCO + MGLY + HAC + 0.5 CH2O + HO2 + NO2 + 0.5 CO                             ', & ! index 593
     '          MVKN --> GLYC + MCO3 + NO2                                                                ', & ! index 594
     '        ISOPNB --> HC5 + HO2 + NO2                                                                  ', & ! index 595
     '           Br2 --> 2 Br                                                                             ', & ! index 596
     '           BrO --> O3 + Br                                                                          ', & ! index 597
     '          HOBr --> LOx + OH + Br                                                                    ', & ! index 598
     '         BrNO3 --> Br + NO3                                                                         ', & ! index 599
     '         BrNO3 --> BrO + NO2                                                                        ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_20 = (/ &
     '         BrNO2 --> Br + NO2                                                                         ', & ! index 601
     '         CHBr3 --> 3 Br                                                                             ', & ! index 602
     '        CH2Br2 --> 2 Br                                                                             ', & ! index 603
     '         CH3Br --> Br + MO2                                                                         ', & ! index 604
     '         CH3Cl --> MO2 + Cl                                                                         ', & ! index 605
     '        CH2Cl2 --> 2 Cl                                                                             ', & ! index 606
     '          BrCl --> Br + Cl                                                                          ', & ! index 607
     '           Cl2 --> 2 Cl                                                                             ', & ! index 608
     '           ClO --> O3 + Cl                                                                          ', & ! index 609
     '          OClO --> ClO + O3                                                                         ', & ! index 610
     '         Cl2O2 --> 2 LOx + ClOO + Cl                                                                ', & ! index 611
     '         ClNO2 --> NO2 + Cl                                                                         ', & ! index 612
     '         ClNO3 --> Cl + NO3                                                                         ', & ! index 613
     '         ClNO3 --> ClO + NO2                                                                        ', & ! index 614
     '          HOCl --> LOx + OH + Cl                                                                    ', & ! index 615
     '          ClOO --> Cl + O2                                                                          ', & ! index 616
     '            I2 --> 2 I                                                                              ', & ! index 617
     '           HOI --> LOx + I + OH                                                                     ', & ! index 618
     '            IO --> I + O3                                                                           ', & ! index 619
     '           OIO --> 2 LOx + I + O2                                                                   ', & ! index 620
     '           INO --> I + NO                                                                           ', & ! index 621
     '          IONO --> I + NO2                                                                          ', & ! index 622
     '         IONO2 --> I + NO3                                                                          ', & ! index 623
     '          I2O2 --> OIO + I                                                                          ', & ! index 624
     '          CH3I --> I                                                                                ', & ! index 625
     '         CH2I2 --> 2 I                                                                              ', & ! index 626
     '        CH2ICl --> I + Cl                                                                           ', & ! index 627
     '        CH2IBr --> I + Br                                                                           ', & ! index 628
     '          I2O4 --> 2 OIO                                                                            ', & ! index 629
     '          I2O3 --> OIO + IO                                                                         ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(16) :: EQN_NAMES_21 = (/ &
     '           IBr --> I + Br                                                                           ', & ! index 631
     '           ICl --> I + Cl                                                                           ', & ! index 632
     '           MPN --> POx + CH2O + HO2 + NO3                                                           ', & ! index 633
     '           MPN --> MO2 + NO2                                                                        ', & ! index 634
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', & ! index 635
     '        PROPNN --> PCO + CH2O + MO2 + NO2 + CO                                                      ', & ! index 636
     '         ATOOH --> CH2O + MCO3 + OH                                                                 ', & ! index 637
     '           PIP --> RCHO + HO2 + OH                                                                  ', & ! index 638
     '          IPMN --> 0.4 CO2 + 0.4 POx + 0.6 IMAO3 + 0.4 CH2O + 0.4 MCO3 + 0.6 NO2 + 0.4 NO3          ', & ! index 639
     '         ETHLN --> PCO + CH2O + HO2 + NO2 + CO                                                      ', & ! index 640
     '          DHDC --> GLYX + MGLY + 2 OH                                                               ', & ! index 641
     '         HPALD --> 1.89 PCO + 0.11 GLYC + 0.5 MGLY + 0.39 HAC + 0.11 MCO3 + 0.89 HO2 + 2 OH + 1.89 C', & ! index 642
     '          ISN1 --> 0.25 GLYX + 0.5 GLYC + 0.25 MGLY + 0.5 HAC + CH2O + HO2 + NO2                    ', & ! index 643
     '        MONITS --> POx + MEK + NO2                                                                  ', & ! index 644
     '        MONITU --> POx + RCHO + NO2                                                                 ', & ! index 645
     '         HONIT --> POx + HAC + NO2                                                                  ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(646) :: EQN_NAMES = (/&
