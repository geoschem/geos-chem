...
!
      ...
      ! SO2 + O3 ...
         k_ex  = ARSL1K( State_Chm%WetAeroArea(I,J,L,11), &
              XRADI(11), XDENA, 0.11_dp, XTEMP, &
              SQRT(State_Chm%SpcData(id_SO2)%Info%Mw_g))
         K_MT(1) = kIIR1Ltd(C(ind_SO2), C(ind_O3), k_ex)/State_Chm%Species(I,J,L,id_SALAAL)!**2
      endif

      ! HCl
      k_ex = ARSL1K( State_Chm%WetAeroArea(I,J,L,11), &
           XRADI(11), XDENA, 0.074_dp, XTEMP, &
           SQRT(State_Chm%SpcData(id_HCl)%Info%Mw_g))
      ...
      ! HNO3
      k_ex = ARSL1K( State_Chm%WetAeroArea(I,J,L,11), &
           XRADI(11), XDENA, 0.5_dp, XTEMP, &
           SQRT(State_Chm%SpcData(id_HNO3)%Info%Mw_g))
