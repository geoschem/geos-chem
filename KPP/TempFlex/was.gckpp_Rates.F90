...
! Temperature Dependent Branching Ratio
      ...
      REAL(kind=dp) R0,R1
      R0 =  DBLE(A0) * EXP(DBLE(C0)/TEMP) * (300._dp/DBLE(TEMP))**DBLE(B0)
      R1 =  DBLE(A1) * EXP(DBLE(C1)/TEMP) * (300._dp/DBLE(TEMP))**DBLE(B1)
...
! End INLINED RCONST
  ...
  RCONST(25) = (GC_OHHNO3(2.41E-14,0.0E+00,460.0,2.7E-17,0.E0,2199.,6.5E-34,0.E0,1335.))
  ...
  RCONST(47) = (GC_TBRANCH(7.60E-12,0.0E+00,-585.0,5.9E0,0.64E0,-816.))
  ...
  RCONST(52) = (GC_RO2NO('B',2.70E-12,0.0E+00,350.0,4.E0,0.,0.))
  ...
  RCONST(293) = (PHOTOL(3))
  RCONST(294) = (PHOTOL(103))
  RCONST(295) = (PHOTOL(11))
  RCONST(296) = (PHOTOL(9))
  RCONST(297) = (PHOTOL(10))
  RCONST(298) = (PHOTOL(7))
  RCONST(299) = (PHOTOL(8))
  RCONST(300) = (PHOTOL(16))
  RCONST(301) = (PHOTOL(15))
!  RCONST(302) = (0.95_dp*PHOTOL(18))
!  RCONST(303) = (0.05_dp*PHOTOL(17))
!  RCONST(304) = (0.866_dp*PHOTOL(12))
!  RCONST(305) = (0.114_dp*PHOTOL(13))
  RCONST(302) = (1._dp*PHOTOL(17))
  RCONST(303) = (1._dp*PHOTOL(18))
  RCONST(304) = (1._dp*PHOTOL(12))
  RCONST(305) = (1._dp*PHOTOL(13))
  RCONST(306) = (PHOTOL(14))
  RCONST(307) = (PHOTOL(61))
  RCONST(308) = (PHOTOL(62))
  RCONST(309) = (PHOTOL(59))
  RCONST(310) = (PHOTOL(70))
  RCONST(311) = (PHOTOL(76))
  RCONST(312) = (PHOTOL(77))
  RCONST(313) = (PHOTOL(69))
  RCONST(314) = (PHOTOL(68))
  RCONST(315) = (PHOTOL(72))
  RCONST(316) = (PHOTOL(73))
  RCONST(317) = (PHOTOL(74))
  RCONST(318) = (PHOTOL(71))
!  RCONST(319) = (0.60_dp*PHOTOL(64))
!  RCONST(320) = (0.20_dp*PHOTOL(66))
!  RCONST(321) = (0.20_dp*PHOTOL(65))
  RCONST(319) = (1._dp*PHOTOL(63))
  RCONST(320) = (1._dp*PHOTOL(64))
  RCONST(321) = (1._dp*PHOTOL(65))
  RCONST(322) = (PHOTOL(66))
  RCONST(323) = (PHOTOL(75))
  RCONST(324) = (PHOTOL(78))
  RCONST(325) = (PHOTOL(79))
!  RCONST(326) = (0.50_dp*PHOTOL(80))
  RCONST(326) = (1.0_dp*PHOTOL(80))
  RCONST(327) = (PHOTOL(81))
  RCONST(328) = (PHOTOL(82))
  RCONST(329) = (PHOTOL(83))
  RCONST(330) = (PHOTOL(84))
  RCONST(331) = (PHOTOL(85))
  RCONST(332) = (PHOTOL(86))
  RCONST(333) = (PHOTOL(87))
  RCONST(334) = (PHOTOL(88))
  RCONST(335) = (PHOTOL(89))
  RCONST(336) = (PHOTOL(90))
  RCONST(337) = (PHOTOL(91))
  RCONST(338) = (PHOTOL(98))
  RCONST(339) = (PHOTOL(99))
  RCONST(340) = (PHOTOL(92))
  RCONST(341) = (PHOTOL(93))
  RCONST(342) = (PHOTOL(94))
  RCONST(343) = (PHOTOL(23))
  RCONST(344) = (PHOTOL(28))
  RCONST(345) = (PHOTOL(32))
!  RCONST(346) = (0.85_dp*PHOTOL(29))
!  RCONST(347) = (0.15_dp*PHOTOL(30))
  RCONST(346) = (1._dp*PHOTOL(29))
  RCONST(347) = (1._dp*PHOTOL(30))
  RCONST(348) = (PHOTOL(31))
  RCONST(349) = (PHOTOL(56))
!  RCONST(350) = (0.05_dp*PHOTOL(104))
!  RCONST(351) = (0.95_dp*PHOTOL(105))
  RCONST(350) = (1._dp*PHOTOL(104))
  RCONST(351) = (1._dp*PHOTOL(105))
  RCONST(352) = (PHOTOL(95))
  RCONST(353) = (PHOTOL(96))
  RCONST(354) = (PHOTOL(97))
