...
! End INLINED RCONST
  ...
  RCONST(17) = (GC_TBRANCH(9.50E-14,0.0E+00,390.0,2.6E1,0.E0,-1130.0))
  ...
  RCONST(34) = (GCJPLPR(2.0E-30,4.4,0.,1.4E-12,0.7,0.,0.8,0.,0.))
  RCONST(35) = (GCJPLPR(7.4E4,4.4,-11000.,5.18E14,0.7,-11000.,0.6,0.,0.))
  ...
  RCONST(253) = (GCJPLPR(4.20E-31,2.4E+00,0.,2.7E-12,0.E0,0.,0.6,0.,0.))
