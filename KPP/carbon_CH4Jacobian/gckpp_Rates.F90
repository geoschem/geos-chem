...
! End inlined code from F90_RCONST
  ...
  RCONST(2) = (2.45d-12*EXP(-1775.0d0/TEMP)*TROP)
  RCONST(3) = (2.45d-12*EXP(-1775.0d0/TEMP)*TROP)
  RCONST(4) = (2.45d-12*EXP(-1775.0d0/TEMP)*TROP)
  RCONST(5) = (2.45d-12*EXP(-1775.0d0/TEMP)*TROP)
  RCONST(6) = (2.45d-12*EXP(-1775.0d0/TEMP)*TROP)
  RCONST(7) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(8) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(9) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(10) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(11) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(12) = (9.60d-12*EXP(-1360.0d0/TEMP)*TROP)
  RCONST(13) = (k_Trop(1))
  RCONST(14) = (k_Trop(2))
  RCONST(15) = (k_Trop(3))
  RCONST(16) = (k_Strat(1))
