...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '     KO2 + MO2 --> 0.25 ROH + 0.75 CH2O + 0.5 ALD2 + 0.5 HO2 + 0.25 MEK ... etc.                    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    MAO3 + HO2 --> 0.41 MAOP + 0.39 CO + 0.59 CH2O + 0.44 OH + 0.15 O3 ... etc.                     ', &
     '     PRPE + OH --> PO2                                                                              ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     ...
     '         CHBr3 --> 3 Br                                                                             ', &
     '           MPN --> CH2O + HO2 + NO3                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(4) :: EQN_NAMES_12 = (/ &
     '           MPN --> NO2 + MO2                                                                        ', &
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', &
     '        PROPNN --> CO + CH2O + NO2 + MO2                                                            ', &
     '         ATOOH --> CH2O + OH + MCO3                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(364) :: EQN_NAMES = (/&
