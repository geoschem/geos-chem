...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'PYAC           ','CO2            ','POx            ', & ! index 16 - 18
     'LOx            ','PCO            ','LCO            ', & ! index 19 - 21
     'PSO4           ','TOLU           ','XYLE           ', & ! index 22 - 24
     'CHBr3          ','CH2Br2         ','CH3Br          ', & ! index 25 - 27
     'BENZ           ','PPN            ','BrNO2          ', & ! index 28 - 30
     'IEPOX          ','PMNN           ','N2O5           ', & ! index 31 - 33
     'BRO2           ','TRO2           ','XRO2           ', & ! index 34 - 36
     'PAN            ','ALK4           ','MAP            ', & ! index 37 - 39
     'HNO2           ','MPN            ','MP             ', & ! index 40 - 42
     'RA3P           ','RB3P           ','DMS            ', & ! index 43 - 45
     'ETP            ','C3H8           ','HNO4           ', & ! index 46 - 48
     'MAOP           ','HOBr           ','Br2            ', & ! index 49 - 51
     'HBr            ','RP             ','PP             ', & ! index 52 - 54
     'PRPN           ','BrNO3          ','ETHLN          ', & ! index 55 - 57
     'C2H6           ','H2O2           ','R4P            ', & ! index 58 - 60
     'ATOOH          ','HCOOH          ','RIP            ', & ! index 61 - 63
     'VRP            ','IAP            ','MRP            ', & ! index 64 - 66
     'DHMOB          ','MOBA           ','ISNOHOO        ', & ! index 67 - 69
     'ISNP           ','ISOPNB         ','IEPOXOO        ', & ! index 70 - 72
     'ROH            ','MOBAOO         ','DIBOO          ', & ! index 73 - 75
     'ISNOOB         ','PMN            ','MACRNO2        ', & ! index 76 - 78
     'MVKOO          ','INPN           ','ACTA           ', & ! index 79 - 81
     'GAOO           ','CH3CHOO        ','ACET           ', & ! index 82 - 84
     'BrO            ','MVKN           ','CH2OO          ', & ! index 85 - 87
     'ISOP           ','PRPE           ','MGLYOO         ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(58) :: SPC_NAMES_1 = (/ &
     'ISOPND         ','MGLOO          ','HNO3           ', & ! index 91 - 93
     'A3O2           ','PROPNN         ','MAOPO2         ', & ! index 94 - 96
     'GLYX           ','MACROO         ','MACRN          ', & ! index 97 - 99
     'PO2            ','MAN2           ','ISNOOA         ', & ! index 100 - 102
     'PRN1           ','B3O2           ','KO2            ', & ! index 103 - 105
     'VRO2           ','HC5OO          ','ETO2           ', & ! index 106 - 108
     'GLYC           ','RCO3           ','R4N1           ', & ! index 109 - 111
     'ATO2           ','ISN1           ','MAO3           ', & ! index 112 - 114
     'SO2            ','MGLY           ','RIO2           ', & ! index 115 - 117
     'INO2           ','HC5            ','CH2O           ', & ! index 118 - 120
     'MRO2           ','ISOPNBO2       ','ISOPNDO2       ', & ! index 121 - 123
     'HAC            ','R4O2           ','ALD2           ', & ! index 124 - 126
     'R4N2           ','RCHO           ','MEK            ', & ! index 127 - 129
     'Br             ','HO2            ','NO2            ', & ! index 130 - 132
     'CO             ','MO2            ','NO3            ', & ! index 133 - 135
     'O3             ','OH             ','MACR           ', & ! index 136 - 138
     'MCO3           ','NO             ','MVK            ', & ! index 139 - 141
     'CH4            ','EOH            ','H2             ', & ! index 142 - 144
     'H2O            ','MOH            ','O2             ', & ! index 145 - 147
     'RCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(148) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     R4O2 + NO --> POx + 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.13 RCHO + 0.1', & ! index 52
     ...
     '     RIO2 + NO --> POx + 0.047 ISOPNB + 0.1 DIBOO + 0.07 ISOPND + 0.123 HC5 + 0.66 CH2O + 0.783 HO2 ', & ! index 57
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '     INO2 + NO --> POx + 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.8 HO2 + 1.3 NO2 + 0.035 MACR + 0.035 MV', & ! index 64
     '    INO2 + NO3 --> LOx + 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.8 HO2 + 1.3 NO2 + 0.035 MACR + 0.035 MV', & ! index 65
     '    ISN1 + NO3 --> 1.4 LOx + 0.4 ISNOOB + 0.6 HNO3 + 0.6 ISNOOA                                     ', & ! index 66
     '  ISNOOA + NO3 --> LOx + PCO + R4N2 + HO2 + NO2 + CO                                                ', & ! index 67
     '   ISNOOA + NO --> POx + PCO + R4N2 + HO2 + NO2 + CO                                                ', & ! index 68
     ...
     '        2 INO2 --> 0.5 ISOPND + 1.2 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.8 HO2 + 0.3 NO2 + 0.035 MACR + 0', & ! index 80
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + POx + 0.5 PCO + 0.5 CH2O + NO2 + 0.5 CO + 0.5 MO2 + 0.5 MCO3               ', & ! index 91
     ...
     '    RIO2 + HO2 --> 0.88 RIP + 0.12 CH2O + 0.12 HO2 + 0.12 OH + 0.047 MACR + 0.073 MVK               ', & ! index 100
     '    VRO2 + HO2 --> 0.1 VRP + 0.578 GLYC + 0.102 MGLY + 0.102 CH2O + 0.033 RCHO + 0.187 MEK + 0.102 H', & ! index 101
     ...
     '     KO2 + MO2 --> 0.25 ROH + 0.75 CH2O + 0.5 ALD2 + 0.25 MEK + 0.5 HO2 + 0.5 MCO3 + 0.25 MOH       ', & ! index 113
     '    RIO2 + MO2 --> 0.24 ROH + 0.3 HC5 + 1.22 CH2O + 1.1 HO2 + 0.18 MACR + 0.28 MVK + 0.24 MOH       ', & ! index 114
     '        2 RIO2 --> 0.48 ROH + 0.5 HC5 + 0.92 CH2O + 1.28 HO2 + 0.36 MACR + 0.56 MVK                 ', & ! index 115
     '   HC5OO + MO2 --> 0.33 PCO + 0.25 ROH + 0.13 GLYC + 0.29 MGLY + 0.95 CH2O + 0.18 HAC + 0.25 MEK + H', & ! index 116
     '    VRO2 + MO2 --> 0.25 ROH + 0.36 GLYC + 0.14 MGLY + 0.89 CH2O + 0.25 MEK + 0.64 HO2 + 0.36 MCO3 + ', & ! index 117
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     '    INO2 + MO2 --> 0.25 ISOPND + 0.6 ISN1 + 0.115 HC5 + 0.785 CH2O + 0.9 HO2 + 0.15 NO2 + 0.018 MACR', & ! index 121
     ...
     '    HO2 + MCO3 --> 0.15 POx + 0.41 MAP + 0.15 ACTA + 0.44 MO2 + 0.15 O3 + 0.44 OH                   ', & ! index 130
     '    RCO3 + HO2 --> 0.15 POx + 0.41 RP + 0.44 ETO2 + 0.15 O3 + 0.44 OH + 0.15 RCOOH                  ', & ! index 131
     '    MAO3 + HO2 --> 0.15 POx + 0.39 PCO + 0.41 MAOP + 0.59 CH2O + 0.39 CO + 0.39 MO2 + 0.15 O3 + 0.44', & ! index 132
     ...
     '     OH + MACR --> 0.53 MAO3 + 0.47 MRO2                                                            ', & ! index 146
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '      O3 + MVK --> LOx + 0.56 PCO + 0.12 CH2OO + 0.12 MGLOO + 0.5 MGLY + 0.6 CH2O + 0.1 ALD2 + 0.28 ', & ! index 154
     '     O3 + MACR --> LOx + 0.767 PCO + 0.211 CH2OO + 0.022 MGLYOO + 0.88 MGLY + 0.12 CH2O + 0.317 HO2 ', & ! index 155
     '    ISOP + NO3 --> LISOPNO3 + LOx + INO2                                                            ', & ! index 156
     '    NO3 + MACR --> LOx + MAN2                                                                       ', & ! index 157
     '    NO3 + MACR --> LOx + HNO3 + MAO3                                                                ', & ! index 158
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4O2 + MCO3 --> 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.13 RCHO + 0.19 MEK ', & ! index 196
     '   ATO2 + MCO3 --> CH2O + MO2 + MCO3                                                                ', & ! index 197
     '    KO2 + MCO3 --> ALD2 + MO2 + MCO3                                                                ', & ! index 198
     '   RIO2 + MCO3 --> CO2 + 0.113 DIBOO + 0.14 HC5 + 0.747 CH2O + 0.887 HO2 + MO2 + 0.294 MACR + 0.453 ', & ! index 199
     ...
     '   MAN2 + MCO3 --> CO2 + 0.5 PCO + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 0.5 HO2 + 0.5 NO2 + 0.5 CO + M', & ! index 205
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.8 HO2 + 0.3 NO2 + MO2 + 0.035 MACR + 0.035 MV', & ! index 206
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '    DHMOB + OH --> 1.5 PCO + 0.5 HAC + 0.5 MEK + HO2 + 1.5 CO                                       ', & ! index 282
     ...
     '     MOBA + O3 --> CO2 + LOx + MEK + HO2 + OH                                                       ', & ! index 290
     ...
     '   MACROO + NO --> POx + NO2 + MACR                                                                 ', & ! index 299
     '  MACROO + NO2 --> POx + NO3 + MACR                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     ...
     '    MVKOO + NO --> POx + NO2 + MVK                                                                  ', & ! index 305
     '   MVKOO + NO2 --> POx + NO3 + MVK                                                                  ', & ! index 306
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     ...
     '            O3 --> LOx + 2 OH                                                                       ', & ! index 345
     '            O3 --> LOx + HO2 + OH                                                                   ', & ! index 346
     '           NO2 --> O3 + NO                                                                          ', & ! index 347
     '          H2O2 --> 2 OH                                                                             ', & ! index 348
     '            MP --> CH2O + HO2 + OH                                                                  ', & ! index 349
     '          CH2O --> PCO + 2 HO2 + CO                                                                 ', & ! index 350
     '          CH2O --> PCO + CO + H2                                                                    ', & ! index 351
     '          HNO3 --> NO2 + OH                                                                         ', & ! index 352
     '          HNO2 --> OH + NO                                                                          ', & ! index 353
     '          HNO4 --> POx + NO3 + OH                                                                   ', & ! index 354
     '          HNO4 --> HO2 + NO2                                                                        ', & ! index 355
     '           NO3 --> NO2 + O3                                                                         ', & ! index 356
     '           NO3 --> 2 LOx + NO + O2                                                                  ', & ! index 357
     '          N2O5 --> NO2 + NO3                                                                        ', & ! index 358
     '          ALD2 --> 0.88 PCO + HO2 + 0.88 CO + 0.88 MO2 + 0.12 MCO3                                  ', & ! index 359
     '          ALD2 --> PCO + CO + CH4                                                                   ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     '           PAN --> 0.3 POx + 0.7 NO2 + 0.3 MO2 + 0.3 NO3 + 0.7 MCO3                                 ', & ! index 361
     '          RCHO --> PCO + ETO2 + HO2 + CO                                                            ', & ! index 362
     '          ACET --> MO2 + MCO3                                                                       ', & ! index 363
     '          ACET --> PCO + CO + 2 MO2                                                                 ', & ! index 364
     '           MEK --> 0.85 ETO2 + 0.15 RCO3 + 0.15 MO2 + 0.85 MCO3                                     ', & ! index 365
     '          GLYC --> PCO + 0.9 CH2O + 1.73 HO2 + CO + 0.07 OH + 0.1 MOH                               ', & ! index 366
     '          GLYX --> 2 PCO + 2 HO2 + 2 CO                                                             ', & ! index 367
     '          GLYX --> 2 PCO + 2 CO + H2                                                                ', & ! index 368
     '          GLYX --> PCO + CH2O + CO                                                                  ', & ! index 369
     '          MGLY --> PCO + HO2 + CO + MCO3                                                            ', & ! index 370
     '           MVK --> PCO + PRPE + CO                                                                  ', & ! index 371
     '           MVK --> PCO + CH2O + HO2 + CO + MCO3                                                     ', & ! index 372
     '           MVK --> RCO3 + MO2                                                                       ', & ! index 373
     '          MACR --> PCO + CH2O + HO2 + CO + MCO3                                                     ', & ! index 374
     '           HAC --> CH2O + HO2 + MCO3                                                                ', & ! index 375
     '          INPN --> RCHO + HO2 + NO2 + OH                                                            ', & ! index 376
     '          PRPN --> RCHO + HO2 + NO2 + OH                                                            ', & ! index 377
     ...
     '           RIP --> 0.29 HC5 + 0.71 CH2O + HO2 + OH + 0.285 MACR + 0.425 MVK                         ', & ! index 384
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + HO2 + 0.67 CO + OH + 0.19 H2       ', & ! index 385
     '          ISNP --> RCHO + HO2 + NO2 + OH                                                            ', & ! index 386
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.3 HO2 + OH + 0.7 MCO3                         ', & ! index 387
     '           MRP --> 0.5 PCO + 0.5 CH2O + HAC + HO2 + 0.5 CO + OH                                     ', & ! index 388
     '          MAOP --> CH2O + OH + MCO3                                                                 ', & ! index 389
     '          R4N2 --> 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.13 RCHO + 0.19 MEK ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(16) :: EQN_NAMES_13 = (/ &
     '           MAP --> MO2 + OH                                                                         ', & ! index 391
     '         MACRN --> 0.5 PCO + MGLY + 0.5 CH2O + HAC + HO2 + NO2 + 0.5 CO                             ', & ! index 392
     '          MVKN --> GLYC + NO2 + MCO3                                                                ', & ! index 393
     '        ISOPNB --> HC5 + HO2 + NO2                                                                  ', & ! index 394
     '           Br2 --> 2 Br                                                                             ', & ! index 395
     '           BrO --> Br + O3                                                                          ', & ! index 396
     '          HOBr --> LOx + Br + OH                                                                    ', & ! index 397
     '         BrNO3 --> Br + NO3                                                                         ', & ! index 398
     '         BrNO3 --> BrO + NO2                                                                        ', & ! index 399
     '         BrNO2 --> Br + NO2                                                                         ', & ! index 400
     '         CHBr3 --> 3 Br                                                                             ', & ! index 401
     '           MPN --> POx + CH2O + HO2 + NO3                                                           ', & ! index 402
     '           MPN --> NO2 + MO2                                                                        ', & ! index 403
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', & ! index 404
     '        PROPNN --> PCO + CH2O + NO2 + CO + MO2                                                      ', & ! index 405
     '         ATOOH --> CH2O + OH + MCO3                                                                 ' /)
