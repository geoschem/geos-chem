...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'ACET           ','ISNOHOO        ','BrO            ', &
     'CH2OO          ','ISOP           ','PRPE           ', &
     'MGLYOO         ','ISOPND         ','ISNOOB         ', &
     'MGLOO          ','HNO3           ','A3O2           ', &
     'MAOPO2         ','PROPNN         ','GLYX           ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(53) :: SPC_NAMES_1 = (/ &
     'MACRN          ','MACROO         ','PO2            ', &
     'ISNOOA         ','MAN2           ','B3O2           ', &
     'PRN1           ','KO2            ','HC5OO          ', &
     'GLYC           ','VRO2           ','ETO2           ', &
     ...
     'H2O            ','HCOOH          ','MOH            ', &
     'O2             ','RCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(143) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     R4O2 + NO --> R4N2                                                                             ', &
     '     R4N1 + NO --> 0.39 CH2O + 0.3 R4O2 + 0.75 ALD2 + 2 NO2 + 0.57 RCHO ... etc.                    ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '     INO2 + NO --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MVK + 0.035 MACR ... etc.                ', &
     '    INO2 + NO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MVK + 0.035 MACR ... etc.                ', &
     '    ISN1 + NO3 --> 0.4 ISNOOB + 0.6 HNO3 + 0.6 ISNOOA                                               ', &
     '  ISNOOA + NO3 --> R4N2 + NO2 + CO + HO2                                                            ', &
     '   ISNOOA + NO --> R4N2 + NO2 + CO + HO2                                                            ', &
     '  ISNOOA + NO2 --> PMN                                                                              ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + 0.5 CH2O + 0.5 MCO3 + NO2 + 0.5 CO + 0.5 MO2                               ', &
     '    NO3 + RCHO --> HNO3 + RCO3                                                                      ', &
     '     ACET + OH --> ATO2 + H2O                                                                       ', &
     ...
     '    R4N1 + MO2 --> 0.25 ROH + 0.95 CH2O + 0.15 R4O2 + 0.38 ALD2 + NO2 + 0.5 HO2 ... etc.            ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    PRN1 + MO2 --> 0.25 ROH + 1.25 CH2O + 0.5 ALD2 + NO2 + 0.5 HO2 + 0.25 RCHO ... etc.             ', &
     '      OH + EOH --> ALD2 + HO2                                                                       ', &
     '      ROH + OH --> HO2 + RCHO                                                                       ', &
     '        2 ETO2 --> 2 ALD2 + 2 HO2                                                                   ', &
     '        2 ETO2 --> ALD2 + EOH                                                                       ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_5 = (/ &
     ...
     '      R4P + OH --> 0.209 R4O2 + 0.791 OH + 0.791 RCHO                                               ', &
     '       RP + OH --> RCO3                                                                             ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4N1 + MCO3 --> 0.39 CH2O + 0.3 R4O2 + 0.75 ALD2 + NO2 + MO2 + 0.57 RCHO ... etc.                ', &
     '   MAN2 + MCO3 --> CO2 + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 0.5 NO2 + 0.5 CO ... etc.               ', &
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MVK + 0.035 MACR ... etc.                ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   VRO2 + MCO3 --> MEK + ACTA                                                                       ', &
     '   MRO2 + MCO3 --> MEK + ACTA                                                                       ', &
     '   R4N1 + MCO3 --> NO2 + RCHO + ACTA                                                                ', &
     '   MAN2 + MCO3 --> NO2 + RCHO + ACTA                                                                ', &
     '   INO2 + MCO3 --> NO2 + RCHO + ACTA                                                                ', &
     '   PRN1 + MCO3 --> NO2 + RCHO + ACTA                                                                ', &
     '   B3O2 + MCO3 --> ACET + ACTA                                                                      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '     MOBA + OH --> MOBAOO                                                                           ', &
     '   MOBAOO + NO --> CO2 + NO2 + HO2 + RCHO                                                           ', &
     '   MOBAOO + NO --> HNO3                                                                             ', &
     '  MOBAOO + HO2 --> 0.5 CO2 + 0.5 R4P + 0.5 OH + 0.5 HO2 + 0.5 RCHO                                  ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '           HAC --> CH2O + MCO3 + HO2                                                                ', &
     '          INPN --> OH + NO2 + HO2 + RCHO                                                            ', &
     '          PRPN --> OH + NO2 + HO2 + RCHO                                                            ', &
     '           ETP --> ALD2 + OH + HO2                                                                  ', &
     '          RA3P --> OH + HO2 + RCHO                                                                  ', &
     '          RB3P --> ACET + OH + HO2                                                                  ', &
     '           R4P --> OH + HO2 + RCHO                                                                  ', &
