...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'HNO2           ','MPN            ','C3H8           ', & ! index 40 - 42
     'MP             ','RA3P           ','RB3P           ', & ! index 43 - 45
     'DMS            ','ETP            ','HNO4           ', & ! index 46 - 48
     'MAOP           ','HOBr           ','Br2            ', & ! index 49 - 51
     'HBr            ','C2H6           ','RP             ', & ! index 52 - 54
     'PP             ','PRPN           ','BrNO3          ', & ! index 55 - 57
     'ETHLN          ','H2O2           ','R4P            ', & ! index 58 - 60
     ...
     'PMN            ','ISNOOB         ','MACRNO2        ', & ! index 76 - 78
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(58) :: SPC_NAMES_1 = (/ &
     ...
     'GLYX           ','MACROO         ','PO2            ', & ! index 97 - 99
     'MACRN          ','MAN2           ','ISNOOA         ', & ! index 100 - 102
     'PRN1           ','B3O2           ','KO2            ', & ! index 103 - 105
     'HC5OO          ','GLYC           ','VRO2           ', & ! index 106 - 108
     'ETO2           ','RCO3           ','R4N1           ', & ! index 109 - 111
     ...
     'R4N2           ','MACR           ','MVK            ', & ! index 127 - 129
     'RCHO           ','Br             ','NO2            ', & ! index 130 - 132
     'CO             ','O3             ','MO2            ', & ! index 133 - 135
     'OH             ','NO3            ','HO2            ', & ! index 136 - 138
     'MCO3           ','NO             ','MEK            ', & ! index 139 - 141
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     R4O2 + NO --> POx + 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.13 RCHO + NO2', & ! index 52
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    VRO2 + HO2 --> 0.1 VRP + 0.578 GLYC + 0.102 MGLY + 0.102 CH2O + 0.033 RCHO + 0.68 OH + 0.102 HO2', & ! index 101
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   VRO2 + MCO3 --> 0.6 GLYC + 0.4 MGLY + 0.4 CH2O + MO2 + 0.4 HO2 + 0.6 MCO3                        ', & ! index 201
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_8 = (/ &
     ...
     '     ALD2 + Br --> HBr + MCO3                                                                       ', & ! index 249
     '     ACET + Br --> HBr + ATO2                                                                       ', & ! index 250
     '     C2H6 + Br --> HBr + ETO2                                                                       ', & ! index 251
     '     C3H8 + Br --> HBr + A3O2                                                                       ', & ! index 252
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '           RIP --> 0.29 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + OH + HO2                         ', & ! index 384
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + 0.67 CO + OH + HO2 + 0.19 H2       ', & ! index 385
     '          ISNP --> RCHO + NO2 + OH + HO2                                                            ', & ! index 386
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + OH + 0.3 HO2 + 0.7 MCO3                         ', & ! index 387
     '           MRP --> 0.5 PCO + 0.5 CH2O + HAC + 0.5 CO + OH + HO2                                     ', & ! index 388
     '          MAOP --> CH2O + OH + MCO3                                                                 ', & ! index 389
     '          R4N2 --> 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.13 RCHO + NO2 + 0.1' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(16) :: EQN_NAMES_13 = (/ &
     '           MAP --> MO2 + OH                                                                         ', & ! index 391
     '         MACRN --> 0.5 PCO + MGLY + 0.5 CH2O + HAC + NO2 + 0.5 CO + HO2                             ', & ! index 392
     '          MVKN --> GLYC + NO2 + MCO3                                                                ', & ! index 393
     '        ISOPNB --> HC5 + NO2 + HO2                                                                  ', & ! index 394
     '           Br2 --> 2 Br                                                                             ', & ! index 395
     '           BrO --> Br + O3                                                                          ', & ! index 396
     ...
     '           MPN --> POx + CH2O + NO3 + HO2                                                           ', & ! index 402
     '           MPN --> NO2 + MO2                                                                        ', & ! index 403
     '        ISOPND --> HC5 + NO2 + HO2                                                                  ', & ! index 404
