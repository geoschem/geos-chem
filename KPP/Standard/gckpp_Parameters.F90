...
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: NONZERO = 2719 
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: LU_NONZERO = 3371 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_BrSALA = 72 
  INTEGER, PARAMETER :: ind_BrSALC = 73 
  ...
  INTEGER, PARAMETER :: ind_DHPCARP = 113 
  INTEGER, PARAMETER :: ind_HC187 = 114 
  INTEGER, PARAMETER :: ind_IAP = 115 
  INTEGER, PARAMETER :: ind_HOI = 116 
  ...
  INTEGER, PARAMETER :: ind_ETHLN = 128 
  ...
  INTEGER, PARAMETER :: ind_ClNO3 = 179 
