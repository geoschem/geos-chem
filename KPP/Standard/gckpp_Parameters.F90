...
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: NONZERO = 2742 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_ClOO = 94 
  INTEGER, PARAMETER :: ind_HNO2 = 95 
  INTEGER, PARAMETER :: ind_OClO = 96 
  INTEGER, PARAMETER :: ind_PAN = 97 
  INTEGER, PARAMETER :: ind_RP = 98 
  INTEGER, PARAMETER :: ind_PP = 99 
  INTEGER, PARAMETER :: ind_PRPN = 100 
  INTEGER, PARAMETER :: ind_SO4 = 101 
  INTEGER, PARAMETER :: ind_ALK4 = 102 
  INTEGER, PARAMETER :: ind_PIP = 103 
  ...
  INTEGER, PARAMETER :: ind_ETHLN = 127 
  INTEGER, PARAMETER :: ind_EOH = 128 
  INTEGER, PARAMETER :: ind_RIPA = 129 
  INTEGER, PARAMETER :: ind_RIPD = 130 
  INTEGER, PARAMETER :: ind_ISNOHOO = 131 
  INTEGER, PARAMETER :: ind_MTPA = 132 
  INTEGER, PARAMETER :: ind_MTPO = 133 
  INTEGER, PARAMETER :: ind_NPMN = 134 
  INTEGER, PARAMETER :: ind_C2H6 = 135 
  ...
  INTEGER, PARAMETER :: ind_IPMN = 140 
  INTEGER, PARAMETER :: ind_ISNOOB = 141 
  INTEGER, PARAMETER :: ind_INPN = 142 
  ...
  INTEGER, PARAMETER :: ind_I2 = 149 
  INTEGER, PARAMETER :: ind_ISOPNB = 150 
  INTEGER, PARAMETER :: ind_CH4 = 151 
  INTEGER, PARAMETER :: ind_MVKOO = 152 
  INTEGER, PARAMETER :: ind_GAOO = 153 
  INTEGER, PARAMETER :: ind_CH3CHOO = 154 
  INTEGER, PARAMETER :: ind_MGLYOO = 155 
  INTEGER, PARAMETER :: ind_IEPOXOO = 156 
  INTEGER, PARAMETER :: ind_GLYX = 157 
  ...
  INTEGER, PARAMETER :: ind_HC5OO = 186 
  ...
  INTEGER, PARAMETER :: ind_HOCl = 195 
  INTEGER, PARAMETER :: ind_ISN1 = 196 
  ...
  INTEGER, PARAMETER :: ind_HBr = 218 
  INTEGER, PARAMETER :: ind_HCl = 219 
  INTEGER, PARAMETER :: ind_O = 220 
