...
! NONZERO - Number of nonzero entries in Jacobian
  INTEGER, PARAMETER :: NONZERO = 2744 
! LU_NONZERO - Number of nonzero entries in LU factoriz. of Jacobian
  INTEGER, PARAMETER :: LU_NONZERO = 3405 
...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_MP = 121 
  INTEGER, PARAMETER :: ind_BrSALA = 122 
  ...
  INTEGER, PARAMETER :: ind_N2O5 = 130 
  ...
  INTEGER, PARAMETER :: ind_HO2 = 229 
  INTEGER, PARAMETER :: ind_Br = 230 
  INTEGER, PARAMETER :: ind_O1D = 231 
  INTEGER, PARAMETER :: ind_NO = 232 
