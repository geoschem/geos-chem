...
! Computation of prod/loss families
  FAM(1) = V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(15)+V(15)&
             &+V(13)+V(13)+V(15)+1.82*V(13)+0.4*V(13)+V(13)+V(13)+V(15)+0.15*V(13)+0.15*V(13)+0.15*V(15)+V(15)+V(13)+V(13)&
             &+V(13)+V(15)+V(13)+2.31*V(13)+V(13)+1.155*V(13)+2*V(13)+V(13)+V(13)+V(13)+1.15*V(13)+0.15*V(13)+V(13)+V(13)&
             &+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)&
             &+V(13)+V(13)+V(13)+V(13)+V(13)+V(13)+2*V(13)+2*V(13)+V(13)+0.3*V(13)+V(13)+V(13)+V(13)
  FAM(2) = V(14)+V(14)+V(14)+V(14)+V(14)+2*V(14)+V(14)+V(14)+V(14)+1.4*V(14)+V(14)+V(14)+0.75*V(14)+V(14)+0.066*V(14)&
             &+0.3*V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+2*V(14)&
             &+V(14)+V(14)+0.5*V(14)+V(14)+V(14)+V(14)+2*V(14)+2*V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+0.388*V(14)&
             &+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+2*V(14)+V(14)+V(14)+2*V(14)+V(14)+2*V(14)+2*V(14)+V(14)&
             &+V(14)+2*V(14)+V(14)+0.67*V(14)+0.65*V(14)+0.56*V(14)+0.17*V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+2*V(14)+2*V(14)&
             &+2*V(14)+2*V(14)+2*V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+V(14)+2*V(14)+V(14)+2*V(14)+V(14)
  FAM(3) = V(15)+V(15)+0.05*V(15)+0.728*V(15)+V(15)+0.5*V(15)+V(15)+V(15)+0.5*V(15)+0.075*V(15)+0.33*V(15)+0.595*V(15)&
             &+0.375*V(15)+0.39*V(15)+0.56*V(15)+V(15)+0.505*V(15)+V(15)+2*V(15)+V(15)+2*V(15)+V(15)+0.5*V(15)+0.512*V(15)&
             &+0.56*V(15)+0.767*V(15)+0.251*V(15)+0.251*V(15)+0.89*V(15)+0.09*V(15)+0.857*V(15)+0.5*V(15)+V(15)+0.09*V(15)&
             &+1.5*V(15)+V(15)+V(15)+V(15)+V(15)+V(15)+V(15)+0.88*V(15)+V(15)+V(15)+V(15)+V(15)+2*V(15)+2*V(15)+V(15)+V(15)&
             &+V(15)+V(15)+V(15)+0.67*V(15)+0.5*V(15)+0.5*V(15)+V(15)+V(15)
  FAM(4) = V(16)+V(16)+V(16)+V(16)+V(16)+V(16)+V(16)
  FAM(5) = V(17)+V(17)+V(17)+V(17)+V(17)+V(17)+V(17)+V(17)
