...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'Cl2O2          ','CH2Br2         ','ClNO2          ', & ! index 79 - 81
     'ETP            ','HCFC123        ','HCFC141b       ', & ! index 82 - 84
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_1 = (/ &
     ...
     'C3H8           ','DHPCARP        ','HC187          ', & ! index 109 - 111
     'HOI            ','IAP            ','VRP            ', & ! index 112 - 114
     'HPC52O2        ','ATOOH          ','Br2            ', & ! index 115 - 117
     'MOBA           ','HONIT          ','DHMOB          ', & ! index 118 - 120
     'RIPB           ','BrSALC         ','MP             ', & ! index 121 - 123
     'ISNP           ','BrSALA         ','MAOP           ', & ! index 124 - 126
     'MRP            ','RIPA           ','RIPD           ', & ! index 127 - 129
     'ETHLN          ','EOH            ','N2O5           ', & ! index 130 - 132
     'INPN           ','MTPA           ','MTPO           ', & ! index 133 - 135
     'NPMN           ','C2H6           ','IONO2          ', & ! index 136 - 138
     'MOBAOO         ','DIBOO          ','LIMO           ', & ! index 139 - 141
     'IPMN           ','H              ','BrNO3          ', & ! index 142 - 144
     'MACRNO2        ','ROH            ','I2             ', & ! index 145 - 147
     'MONITS         ','Cl2            ','ISOPNB         ', & ! index 148 - 150
     'CH4            ','MVKOO          ','ISNOHOO        ', & ! index 151 - 153
     'ISNOOB         ','GAOO           ','CH3CHOO        ', & ! index 154 - 156
     'IEPOXOO        ','GLYX           ','MVKN           ', & ! index 157 - 159
     'MGLYOO         ','MONITU         ','MGLOO          ', & ! index 160 - 162
     'PRN1           ','PROPNN         ','MAN2           ', & ! index 163 - 165
     'ISNOOA         ','ISOPNDO2       ','HCOOH          ', & ! index 166 - 168
     'A3O2           ','MACROO         ','PO2            ', & ! index 169 - 171
     'MAOPO2         ','ISOP           ','H2O2           ', & ! index 172 - 174
     'B3O2           ','ACET           ','R4N1           ', & ! index 175 - 177
     'I              ','RCO3           ','MACRN          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(60) :: SPC_NAMES_2 = (/ &
     'IO             ','OLNN           ','OLND           ', & ! index 181 - 183
     'LIMO2          ','MOH            ','HOBr           ', & ! index 184 - 186
     'ISOPNBO2       ','HNO3           ','ISOPND         ', & ! index 187 - 189
     'ACTA           ','KO2            ','HC5OO          ', & ! index 190 - 192
     'GLYC           ','VRO2           ','HOCl           ', & ! index 193 - 195
     'PIO2           ','ATO2           ','CH2OO          ', & ! index 196 - 198
     'NMAO3          ','ISN1           ','ClNO3          ', & ! index 199 - 201
     'MGLY           ','HC5            ','RIO2           ', & ! index 202 - 204
     'INO2           ','ETO2           ','R4O2           ', & ! index 205 - 207
     'R4N2           ','HAC            ','MRO2           ', & ! index 208 - 210
     'BrO            ','PRPE           ','RCHO           ', & ! index 211 - 213
     'MEK            ','MACR           ','CH2O           ', & ! index 214 - 216
     'ALD2           ','MVK            ','MCO3           ', & ! index 217 - 219
     'SO2            ','HCl            ','HBr            ', & ! index 220 - 222
     'HO2            ','H2O            ','NO3            ', & ! index 223 - 225
     'NO             ','Br             ','O3             ', & ! index 226 - 228
     'Cl             ','ClO            ','O              ', & ! index 229 - 231
     'NO2            ','CO             ','OH             ', & ! index 232 - 234
     'MO2            ','O1D            ','H2             ', & ! index 235 - 237
     'N2             ','O2             ','RCOOH          ' /)
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_2 = (/ &
     ...
     '  ISNOOB + MO2 --> 0.04 ISN1OG + 0.36 POx + 0.7 GLYX + 0.66 PROPNN + 0.25 MOH + 0.75 CH2O + 0.5 HO2 ', & ! index 73
     '     ISN1 + O3 --> LOx + 0.7 GLYX + 0.3 PROPNN + 0.25 MOH + 0.75 CH2O + 0.5 HO2 + 0.7 NO2           ', & ! index 74
     ...
     ' ISNOHOO + MO2 --> 0.04 ISN1OG + 0.34 LOx + 0.7 GLYX + 0.66 PROPNN + 0.25 MOH + 0.75 CH2O + 1.2 HO2 ', & ! index 78
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     ...
     '    A3O2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.75 RCHO + 0.75 CH2O + HO2                                ', & ! index 95
     '     PO2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.16 HAC + 0.09 RCHO + 1.25 CH2O + 0.5 ALD2 + HO2          ', & ! index 96
     ...
     '    ETO2 + MO2 --> 0.25 EOH + 0.25 MOH + 0.75 CH2O + 0.75 ALD2 + HO2                                ', & ! index 109
     '     MEK + NO3 --> LOx + HNO3 + KO2                                                                 ', & ! index 110
     '    R4O2 + MO2 --> 0.25 ROH + 0.03 A3O2 + 0.09 B3O2 + 0.16 ACET + 0.25 MOH + 0.16 ETO2 + 0.07 RCHO +', & ! index 111
     '    R4N1 + MO2 --> 0.25 ROH + 0.25 MOH + 0.15 R4O2 + 0.54 RCHO + 0.95 CH2O + 0.38 ALD2 + 0.5 HO2 + N', & ! index 112
     '    ATO2 + MO2 --> 0.5 MOH + 0.5 MGLY + 0.2 HAC + 0.5 CH2O + 0.3 MCO3 + 0.3 HO2                     ', & ! index 113
     '     KO2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.25 MEK + 0.75 CH2O + 0.5 ALD2 + 0.5 MCO3 + 0.5 HO2       ', & ! index 114
     '    RIO2 + MO2 --> 0.24 ROH + 0.24 MOH + 0.3 HC5 + 0.18 MACR + 1.22 CH2O + 0.28 MVK + 1.1 HO2       ', & ! index 115
     '        2 RIO2 --> 0.29 PCO + 0.09 DIBOO + 1.11 HC5 + 0.29 MACR + 0.75 CH2O + 0.45 MVK + 0.91 HO2 + ', & ! index 116
     '   HC5OO + MO2 --> 0.33 PCO + 0.25 ROH + 0.25 MOH + 0.13 GLYC + 0.29 MGLY + 0.18 HAC + 0.25 MEK + 0.', & ! index 117
     '    VRO2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.36 GLYC + 0.14 MGLY + 0.25 MEK + 0.89 CH2O + 0.36 MCO3 + ', & ! index 118
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     '    B3O2 + MO2 --> 0.25 ROH + 0.75 ACET + 0.25 MOH + 0.75 CH2O + HO2                                ', & ! index 121
     '    INO2 + MO2 --> 0.25 MOH + 0.25 ISOPND + 0.6 ISN1 + 0.115 HC5 + 0.018 MACR + 0.785 CH2O + 0.018 M', & ! index 122
     '    PRN1 + MO2 --> 0.25 ROH + 0.25 MOH + 0.25 RCHO + 1.25 CH2O + 0.5 ALD2 + 0.5 HO2 + NO2           ', & ! index 123
     ...
     '   NMAO3 + HO2 --> 0.15 POx + 0.39 PCO + 0.41 MAOP + 0.59 CH2O + 0.15 O3 + 0.39 CO + 0.44 OH + 0.39 ', & ! index 133
     ...
     '     GLYC + OH --> 0.361 CO2 + 0.505 PCO + 0.134 GLYX + 0.134 HCOOH + 0.732 CH2O + 0.773 HO2 + 0.505', & ! index 140
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_7 = (/ &
     ...
     '   ISOPND + O3 --> 0.63 CO2 + LOx + 0.26 ETHLN + 0.09 EOH + 0.06 GLYX + 0.38 PROPNN + 0.24 MOH + 0.3', & ! index 238
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '      CH2O + O --> LOx + PCO + HO2 + CO + OH                                                        ', & ! index 298
     '     HCl + O1D --> 0.67 LOx + 0.24 H + 0.09 HCl + 0.67 Cl + 0.24 ClO + 0.09 O + 0.67 OH             ', & ! index 299
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_10 = (/ &
     ...
     '   CFC12 + O1D --> 0.14 CFC12 + 0.86 Cl + 0.86 ClO + 0.14 O                                         ', & ! index 308
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_16 = (/ &
     ...
     '    PIO2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.75 RCHO + 0.75 MEK + 0.75 CH2O + HO2                     ', & ! index 492
     ...
     '   LIMO2 + MO2 --> 0.25 ROH + 0.25 MOH + 0.192 PRPE + 0.308 MACR + 1.04 CH2O + HO2                  ', & ! index 504
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_17 = (/ &
     ...
     '    OLND + MO2 --> 0.5 POx + 0.25 ROH + 0.35 MONITS + 0.15 MONITU + 0.25 MOH + 0.93 RCHO + 0.348 MEK', & ! index 513
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_20 = (/ &
     ...
     '          ALD2 --> 0.88 PCO + 0.12 MCO3 + HO2 + 0.88 CO + 0.88 MO2                                  ', & ! index 619
     ...
     '          GLYC --> PCO + 0.1 MOH + 0.9 CH2O + 1.73 HO2 + CO + 0.07 OH                               ', & ! index 626
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_21 = (/ &
     ...
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + HO2 + 0.67 CO + OH + 0.19 H2       ', & ! index 647
     '          ISNP --> RCHO + HO2 + NO2 + OH                                                            ', & ! index 648
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.7 MCO3 + 0.3 HO2 + OH                         ', & ! index 649
     '           MRP --> 0.5 PCO + HAC + 0.5 CH2O + HO2 + 0.5 CO + OH                                     ', & ! index 650
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(5) :: EQN_NAMES_24 = (/ &
     '         HPALD --> 1.89 PCO + 0.11 GLYC + 0.5 MGLY + 0.39 HAC + 0.11 MCO3 + 0.89 HO2 + 1.89 CO + 2 O', & ! index 721
