...
! End INLINED RCONST
  ...
  RCONST(546) = (HET(ind_OH,1))
  RCONST(547) = (HET(ind_OH,2))
  RCONST(548) = (HET(ind_BrNO3,1))
  RCONST(549) = (HET(ind_BrNO3,2))
  RCONST(550) = (HET(ind_ClNO3,1))
  RCONST(551) = (HET(ind_ClNO3,2))
  RCONST(552) = (HET(ind_ClNO3,3))
  RCONST(553) = (HET(ind_ClNO3,4))
  RCONST(554) = (HET(ind_ClNO3,5))
  RCONST(555) = (HET(ind_ClNO3,6))
  RCONST(556) = (HET(ind_ClNO3,7))
  RCONST(557) = (HET(ind_ClNO2,1))
  RCONST(558) = (HET(ind_ClNO2,2))
  RCONST(559) = (HET(ind_ClNO2,3))
  RCONST(560) = (HET(ind_ClNO2,4))
  RCONST(561) = (HET(ind_ClNO2,5))
  RCONST(562) = (HET(ind_ClNO2,6))
  RCONST(563) = (HET(ind_HOCl,1))
  RCONST(564) = (HET(ind_HOCl,2))
  RCONST(565) = (HET(ind_HOCl,3))
  RCONST(566) = (HET(ind_HOCl,4))
  RCONST(567) = (HET(ind_HOCl,5))
  RCONST(568) = (HET(ind_HOCl,6))
  ...
  RCONST(601) = (HET(ind_IONO,4))
  RCONST(602) = (HET(ind_IONO,5))
  RCONST(603) = (HET(ind_IONO,6))
  RCONST(604) = (HET(ind_IONO2,3))
  RCONST(605) = (HET(ind_IONO2,4))
  RCONST(606) = (HET(ind_IONO2,5))
  RCONST(607) = (HET(ind_IONO2,6))
  RCONST(608) = (HET(ind_HOI,3))
  RCONST(609) = (HET(ind_HOI,4))
  RCONST(610) = (HET(ind_HOI,5))
  RCONST(611) = (HET(ind_HOI,6))
  RCONST(612) = (HET(ind_GLYX,1))
  RCONST(613) = (HET(ind_MGLY,1))
  RCONST(614) = (HET(ind_IEPOXA,1))
  RCONST(615) = (HET(ind_IEPOXB,1))
  RCONST(616) = (HET(ind_IEPOXD,1))
  RCONST(617) = (HET(ind_IMAE,1))
  RCONST(618) = (HET(ind_LVOC,1))
  RCONST(619) = (HET(ind_ISN1OG,1))
  RCONST(620) = (HET(ind_ISOPND,1))
  RCONST(621) = (HET(ind_ISOPNB,1))
  RCONST(622) = (HET(ind_MACRN,1))
  RCONST(623) = (HET(ind_MVKN,1))
  RCONST(624) = (HET(ind_R4N2,1))
  RCONST(625) = (HET(ind_DHDN,1))
  RCONST(626) = (HET(ind_MONITS,1))
  RCONST(627) = (HET(ind_MONITU,1))
  RCONST(628) = (HET(ind_HONIT,1))
  RCONST(629) = (PHOTOL(2))
  RCONST(630) = (PHOTOL(3))
  RCONST(631) = (PHOTOL(1))
  RCONST(632) = (PHOTOL(11))
  RCONST(633) = (PHOTOL(9))
  RCONST(634) = (PHOTOL(10))
  RCONST(635) = (PHOTOL(7))
  RCONST(636) = (PHOTOL(8))
  RCONST(637) = (PHOTOL(16))
  RCONST(638) = (PHOTOL(15))
  RCONST(639) = (PHOTOL(17))
  RCONST(640) = (PHOTOL(18))
  RCONST(641) = (PHOTOL(12))
  RCONST(642) = (PHOTOL(13))
  RCONST(643) = (PHOTOL(14))
  RCONST(644) = (PHOTOL(61))
  RCONST(645) = (PHOTOL(62))
  RCONST(646) = (PHOTOL(59))
  RCONST(647) = (PHOTOL(70))
  RCONST(648) = (PHOTOL(76))
  RCONST(649) = (PHOTOL(77))
  RCONST(650) = (PHOTOL(69))
  RCONST(651) = (PHOTOL(68))
  RCONST(652) = (PHOTOL(72))
  RCONST(653) = (PHOTOL(73))
  RCONST(654) = (PHOTOL(74))
  RCONST(655) = (PHOTOL(71))
  RCONST(656) = (PHOTOL(63))
  RCONST(657) = (PHOTOL(64))
  RCONST(658) = (PHOTOL(65))
  RCONST(659) = (PHOTOL(66))
  RCONST(660) = (PHOTOL(75))
  RCONST(661) = (PHOTOL(78))
  RCONST(662) = (PHOTOL(79))
  RCONST(663) = (PHOTOL(80))
  RCONST(664) = (PHOTOL(81))
  RCONST(665) = (PHOTOL(82))
  RCONST(666) = (PHOTOL(83))
  RCONST(667) = (PHOTOL(84))
  RCONST(668) = (PHOTOL(85))
  RCONST(669) = (PHOTOL(86))
  RCONST(670) = (PHOTOL(86))
  RCONST(671) = (PHOTOL(86))
  RCONST(672) = (PHOTOL(87))
  RCONST(673) = (PHOTOL(88))
  RCONST(674) = (PHOTOL(89))
  RCONST(675) = (PHOTOL(90))
  RCONST(676) = (PHOTOL(91))
  RCONST(677) = (PHOTOL(98))
  RCONST(678) = (PHOTOL(99))
  RCONST(679) = (PHOTOL(92))
  RCONST(680) = (PHOTOL(93))
  RCONST(681) = (PHOTOL(94))
  RCONST(682) = (PHOTOL(23))
  RCONST(683) = (PHOTOL(28))
  RCONST(684) = (PHOTOL(32))
  RCONST(685) = (PHOTOL(29))
  RCONST(686) = (PHOTOL(30))
  RCONST(687) = (PHOTOL(31))
  RCONST(688) = (PHOTOL(56))
  RCONST(689) = (PHOTOL(55))
  RCONST(690) = (PHOTOL(50))
  RCONST(691) = (PHOTOL(43))
  RCONST(692) = (PHOTOL(45))
  RCONST(693) = (PHOTOL(33))
  RCONST(694) = (PHOTOL(22))
  RCONST(695) = (PHOTOL(27))
  RCONST(696) = (PHOTOL(25))
  RCONST(697) = (PHOTOL(26))
  RCONST(698) = (PHOTOL(21))
  RCONST(699) = (PHOTOL(19))
  RCONST(700) = (PHOTOL(20))
  RCONST(701) = (PHOTOL(24))
  RCONST(702) = (PHOTOL(44))
  RCONST(703) = (PHOTOL(42))
  RCONST(704) = (PHOTOL(37))
  RCONST(705) = (PHOTOL(38))
  RCONST(706) = (PHOTOL(39))
  RCONST(707) = (PHOTOL(40))
  RCONST(708) = (PHOTOL(41))
  RCONST(709) = (PHOTOL(47))
  RCONST(710) = (PHOTOL(48))
  RCONST(711) = (PHOTOL(49))
  RCONST(712) = (PHOTOL(46))
  RCONST(713) = (PHOTOL(53))
  RCONST(714) = (PHOTOL(51))
  RCONST(715) = (PHOTOL(54))
  RCONST(716) = (PHOTOL(101))
  RCONST(717) = (PHOTOL(114))
  RCONST(718) = (PHOTOL(115))
  RCONST(719) = (PHOTOL(116))
  RCONST(720) = (PHOTOL(117))
  RCONST(721) = (PHOTOL(118))
  RCONST(722) = (PHOTOL(119))
  RCONST(723) = (PHOTOL(120))
  RCONST(724) = (PHOTOL(121))
  RCONST(725) = (PHOTOL(122))
  RCONST(726) = (PHOTOL(123))
  RCONST(727) = (PHOTOL(124))
  RCONST(728) = (PHOTOL(125))
  RCONST(729) = (PHOTOL(126))
  RCONST(730) = (PHOTOL(127))
  RCONST(731) = (PHOTOL(128))
  RCONST(732) = (PHOTOL(129))
  RCONST(733) = (PHOTOL(103))
  RCONST(734) = (PHOTOL(104))
  RCONST(735) = (PHOTOL(95))
  RCONST(736) = (PHOTOL(96))
  RCONST(737) = (PHOTOL(97))
  RCONST(738) = (PHOTOL(36))
  RCONST(739) = (PHOTOL(34))
  RCONST(740) = (PHOTOL(100))
  RCONST(741) = (PHOTOL(6))
  RCONST(742) = (PHOTOL(105))
  RCONST(743) = (PHOTOL(106))
  RCONST(744) = (PHOTOL(107))
  RCONST(745) = (PHOTOL(108))
  RCONST(746) = (PHOTOL(109))
  RCONST(747) = (PHOTOL(110))
  RCONST(748) = (PHOTOL(111))
  RCONST(749) = (PHOTOL(112))
  RCONST(750) = (PHOTOL(113))
