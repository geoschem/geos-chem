...
!
      ...
      IND = Spc_GetIndx( 'NIT', SC%SpcData )
      IF (IND .le. 0) THEN
         TRC_NIT    = 0.0e+0_fp
         SPC_NIT    = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'SO4', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_SO4    = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'HBr', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_HBr    = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'HOBr', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_HOBr   = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'N2O5', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_N2O5   = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'H2O', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_H2O    = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'HCl', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_HCl    = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'ClNO3', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_ClNO3  = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'BrNO3', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_BrNO3  = 0.0e+0_fp
      ELSE
      ...
      IND = Spc_GetIndx( 'HOCl', SC%SpcData )
      IF (IND .le. 0) THEN
         SPC_HOCl   = 0.0e+0_fp
      ELSE
