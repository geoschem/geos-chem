...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '  A3O2 + HO2 --> RA3P                                                                               ', &
     '   PO2 + HO2 --> PP                                                                                 ', &
     '  HO2 + MCO3 --> 0.41 MAP + 0.44 MO2 + 0.15 O3 + 0.44 OH + 0.15 ACTA ... etc.                       ', &
     '  RCO3 + HO2 --> 0.7 RP + 0.3 O3 + 0.3 RCOOH                                                        ', &
     '  GCO3 + HO2 --> 0.71 GP + 0.29 CH2O + 0.29 O3                                                      ', &
     '  HO2 + MAO3 --> 0.7 MAOP + 0.3 O3 + 0.3 RCOOH                                                      ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '  C2H6 + NO3 --> HNO3 + ETO2                                                                        ', &
     '   OH + MNO3 --> CH2O + NO2                                                                         ', &
     '   IALD + OH --> 0.44 IAO2 + 0.15 HO2 + 0.41 MAO3                                                   ', &
     ...
     ' ATO2 + MCO3 --> 0.2 CH2O + 0.8 MGLY + MO2 + 0.8 HO2 + 0.2 MCO3                                     ', &
     ...
     ' VRO2 + MCO3 --> 0.72 GLYC + 0.28 CH2O + 0.28 MGLY + MO2 + 0.28 HO2 + 0.72 MCO3 ... etc.            ', &
     ...
     ' MVN2 + MCO3 --> CH2O + 0.5 MGLY + MO2 + 0.5 HO2 + NO2 + 0.5 MCO3                                   ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '        MGLY --> CO + HO2 + MCO3                                                                    ', &
     '        MGLY --> CO + ALD2                                                                          ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(24) :: EQN_NAMES_10 = (/ &
     '         MVK --> CO + PRPE                                                                          ', &
     ...
     '         VRP --> 0.7 GLYC + 0.3 CH2O + 0.3 MGLY + 0.3 HO2 + 0.7 MCO3 ... etc.                       ', &
     '         MRP --> 0.5 CO + HAC + 0.5 CH2O + HO2 + OH                                                 ', &
     '        MAOP --> CH2O + MCO3 + OH                                                                   ', &
     '        R4N2 --> 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.13 RCHO + 0.32 ALD2 ... etc.                 ', &
     '         MAP --> MO2 + OH                                                                           ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(324) :: EQN_NAMES = (/&
