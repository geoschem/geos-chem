...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'MAOPO2         ','PROPNN         ','MACRN          ', &
     'MACROO         ','PO2            ','ISNOOA         ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(49) :: SPC_NAMES_1 = (/ &
     'MAN2           ','PRN1           ','B3O2           ', &
     'KO2            ','HC5OO          ','GLYC           ', &
     'VRO2           ','ETO2           ','RCO3           ', &
     'R4N1           ','ATO2           ','ISN1           ', &
     ...
     'HCOOH          ','MOH            ','O2             ', &
     'RCOOH          ' /)
  CHARACTER(LEN=15), PARAMETER, DIMENSION(139) :: SPC_NAMES = (/&
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + 0.5 CH2O + 0.5 MO2 + NO2 + 0.5 MCO3 + 0.5 CO                               ', &
     '    RCHO + NO3 --> HNO3 + RCO3                                                                      ', &
     '     ACET + OH --> ATO2 + H2O                                                                       ', &
     ...
     '    MRO2 + HO2 --> MRP                                                                              ', &
     '    MAN2 + HO2 --> 0.85 ISNP + 0.075 PROPNN + 0.075 MGLY + 0.075 CH2O + 0.075 NO2 ... etc.          ', &
     '    B3O2 + HO2 --> RB3P                                                                             ', &
     '    INO2 + HO2 --> INPN                                                                             ', &
     '    PRN1 + HO2 --> PRPN                                                                             ', &
     '      OH + MEK --> KO2 + H2O                                                                        ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    MAO3 + HO2 --> 0.41 MAOP + 0.59 CH2O + 0.15 O3 + 0.39 MO2 + 0.44 OH ... etc.                    ', &
     '     PRPE + OH --> PO2                                                                              ', &
     ...
     '      HAC + OH --> MGLY + HO2                                                                       ', &
     '      HAC + OH --> 0.5 CO2 + 0.5 MO2 + OH + 0.5 CO + 0.5 ACTA + 0.5 HCOOH ... etc.                  ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     ...
     '          ALD2 --> CO + CH4                                                                         ', &
     '           PAN --> 0.3 MO2 + 0.7 NO2 + 0.3 NO3 + 0.7 MCO3                                           ', &
     '          RCHO --> ETO2 + CO + HO2                                                                  ', &
     '          ACET --> MO2 + MCO3                                                                       ' /)
