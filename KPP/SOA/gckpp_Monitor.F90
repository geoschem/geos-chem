...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=32), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'VRP                             ','IAP                             ','DHMOB                           ', &
     'MOBA                            ','INPN                            ','ISNP                            ' /)
  CHARACTER(LEN=32), PARAMETER, DIMENSION(81) :: SPC_NAMES_1 = (/ &
     ...
     'H2O                             ','HCOOH                           ','MOH                             ', &
     'O2                              ','RCOOH                           ','DUMMY                           ' /)
  CHARACTER(LEN=32), PARAMETER, DIMENSION(171) :: SPC_NAMES = (/&
    SPC_NAMES_0, SPC_NAMES_1 /)

  INTEGER, PARAMETER, DIMENSION(171) :: LOOKAT = (/ &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + 0.5 CH2O + 0.5 CO + 0.5 MCO3 + 0.5 MO2 + NO2                               ', &
     '    RCHO + NO3 --> HNO3 + RCO3                                                                      ', &
     '     ACET + OH --> ATO2 + H2O                                                                       ', &
     '     ACET + OH --> ATO2 + H2O                                                                       ', &
     ...
     '    RIO2 + HO2 --> 0.88 RIP + 0.12 CH2O + 0.047 MACR + 0.073 MVK + 0.12 OH ... etc.                 ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    MAO3 + HO2 --> 0.41 MAOP + 0.59 CH2O + 0.39 CO + 0.44 OH + 0.15 O3 ... etc.                     ', &
     '     PRPE + OH --> PO2                                                                              ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   MAN2 + MCO3 --> CO2 + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + 0.5 CO + 0.5 HO2 ... etc.               ', &
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_14 = (/ &
     ...
     '            PP --> CH2O + ALD2 + OH + HO2                                                           ', &
     '            RP --> ALD2 + OH + HO2                                                                  ', &
     '           RIP --> 0.29 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + OH + HO2 ... etc.                ', &
     ...
     '         CHBr3 --> 3 Br                                                                             ', &
     '           MPN --> CH2O + HO2 + NO3                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(4) :: EQN_NAMES_15 = (/ &
     '           MPN --> MO2 + NO2                                                                        ', &
     '        ISOPND --> HC5 + HO2 + NO2                                                                  ', &
     '        PROPNN --> CH2O + CO + MO2 + NO2                                                            ', &
     '         ATOOH --> CH2O + OH + MCO3                                                                 ' /)
  CHARACTER(LEN=100), PARAMETER, DIMENSION(454) :: EQN_NAMES = (/&
