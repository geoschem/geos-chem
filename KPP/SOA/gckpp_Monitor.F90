...
MODULE gckpp_Monitor
  ...
  CHARACTER(LEN=15), PARAMETER, DIMENSION(90) :: SPC_NAMES_0 = (/ &
     ...
     'MPN            ','C3H8           ','MP             ', & ! index 37 - 39
     'RA3P           ','RB3P           ','DMS            ', & ! index 40 - 42
     'HNO4           ','ETP            ','HOBr           ', & ! index 43 - 45
     'Br2            ','HBr            ','MAOP           ', & ! index 46 - 48
     'C2H6           ','RP             ','PP             ', & ! index 49 - 51
     'PRPN           ','BrNO3          ','ETHLN          ', & ! index 52 - 54
     ...
     'MOBAOO         ','DIBOO          ','PMN            ', & ! index 70 - 72
     'MACRNO2        ','ISNOOB         ','MVKOO          ', & ! index 73 - 75
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_1 = (/ &
     ...
     '     R4O2 + NO --> POx + 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.19 MEK + 0.18', & ! index 52
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_3 = (/ &
     '     MAO3 + NO --> CO2 + POx + 0.5 PCO + 0.5 CH2O + 0.5 MO2 + 0.5 MCO3 + 0.5 CO + NO2               ', & ! index 91
     ...
     '    R4N1 + MO2 --> 0.25 ROH + 0.95 CH2O + 0.15 R4O2 + 0.38 ALD2 + 0.5 HO2 + NO2 + 0.54 RCHO + 0.25 M', & ! index 111
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_4 = (/ &
     ...
     '    PRN1 + MO2 --> 0.25 ROH + 1.25 CH2O + 0.5 ALD2 + 0.5 HO2 + NO2 + 0.25 RCHO + 0.25 MOH           ', & ! index 122
     ...
     '    MCO3 + HO2 --> 0.15 POx + 0.41 MAP + 0.15 ACTA + 0.44 MO2 + 0.15 O3 + 0.44 OH                   ', & ! index 130
     '    RCO3 + HO2 --> 0.15 POx + 0.41 RP + 0.44 ETO2 + 0.15 O3 + 0.44 OH + 0.15 RCOOH                  ', & ! index 131
     '    MAO3 + HO2 --> 0.15 POx + 0.39 PCO + 0.41 MAOP + 0.59 CH2O + 0.39 MO2 + 0.39 CO + 0.15 O3 + 0.44', & ! index 132
     '     PRPE + OH --> PO2                                                                              ', & ! index 133
     '     PRPE + O3 --> LOx + 0.56 PCO + 0.12 CH3CHOO + 0.12 CH2OO + 0.5 CH2O + 0.5 ALD2 + 0.28 MO2 + 0.5', & ! index 134
     ...
     '      HAC + OH --> 0.5 CO2 + 0.5 PCO + 0.5 HCOOH + 0.5 ACTA + 0.5 MO2 + 0.5 CO + OH                 ', & ! index 148
     '   A3O2 + MCO3 --> MO2 + HO2 + RCHO                                                                 ', & ! index 149
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_6 = (/ &
     ...
     '   R4O2 + MCO3 --> 0.32 ACET + 0.05 A3O2 + 0.18 B3O2 + 0.32 ETO2 + 0.32 ALD2 + 0.19 MEK + MO2 + 0.27', & ! index 196
     ...
     '   R4N1 + MCO3 --> 0.39 CH2O + 0.3 R4O2 + 0.75 ALD2 + MO2 + NO2 + 0.57 RCHO                         ', & ! index 204
     '   MAN2 + MCO3 --> CO2 + 0.5 PCO + 0.5 PROPNN + 0.5 MGLY + 0.5 CH2O + MO2 + 0.5 CO + 0.5 HO2 + 0.5 N', & ! index 205
     '   INO2 + MCO3 --> 0.7 ISN1 + 0.23 HC5 + 0.07 CH2O + 0.035 MACR + 0.035 MVK + MO2 + 0.8 HO2 + 0.3 NO', & ! index 206
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_9 = (/ &
     ...
     '   MOBAOO + NO --> CO2 + POx + HO2 + NO2 + RCHO                                                     ', & ! index 287
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_11 = (/ &
     ...
     '           PAN --> 0.3 POx + 0.3 NO3 + 0.3 MO2 + 0.7 MCO3 + 0.7 NO2                                 ', & ! index 358
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(30) :: EQN_NAMES_12 = (/ &
     ...
     '          GLYC --> PCO + 0.9 CH2O + CO + 0.07 OH + 1.73 HO2 + 0.1 MOH                               ', & ! index 363
     ...
     '          INPN --> OH + HO2 + NO2 + RCHO                                                            ', & ! index 373
     '          PRPN --> OH + HO2 + NO2 + RCHO                                                            ', & ! index 374
     '           ETP --> ALD2 + OH + HO2                                                                  ', & ! index 375
     '          RA3P --> OH + HO2 + RCHO                                                                  ', & ! index 376
     '          RB3P --> ACET + OH + HO2                                                                  ', & ! index 377
     '           R4P --> OH + HO2 + RCHO                                                                  ', & ! index 378
     '            PP --> CH2O + ALD2 + OH + HO2                                                           ', & ! index 379
     '            RP --> ALD2 + OH + HO2                                                                  ', & ! index 380
     '           RIP --> 0.29 HC5 + 0.71 CH2O + 0.285 MACR + 0.425 MVK + OH + HO2                         ', & ! index 381
     '           IAP --> 0.67 PCO + 0.26 GLYC + 0.58 MGLY + 0.36 HAC + 0.67 CO + OH + HO2 + 0.19 H2       ', & ! index 382
     '          ISNP --> OH + HO2 + NO2 + RCHO                                                            ', & ! index 383
     '           VRP --> 0.7 GLYC + 0.3 MGLY + 0.3 CH2O + 0.7 MCO3 + OH + 0.3 HO2                         ', & ! index 384
     '           MRP --> 0.5 PCO + 0.5 CH2O + HAC + 0.5 CO + OH + HO2                                     ', & ! index 385
  ...
  CHARACTER(LEN=100), PARAMETER, DIMENSION(13) :: EQN_NAMES_13 = (/ &
     ...
     '        PROPNN --> PCO + CH2O + MO2 + CO + NO2                                                      ', & ! index 402
     '         ATOOH --> CH2O + MCO3 + OH                                                                 ' /)
