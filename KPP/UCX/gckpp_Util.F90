...
! Computation of prod/loss families
  ...
  FAM(3) = V(7)+V(7)+0.05*V(7)+0.728*V(7)+V(7)+0.5*V(7)+V(7)+V(7)+0.5*V(7)+0.075*V(7)+0.33*V(7)+0.595*V(7)+0.375*V(7)&
             ...
             &+0.251*V(7)+0.251*V(7)+0.89*V(7)+0.09*V(7)+0.857*V(7)+0.5*V(7)+V(7)+0.09*V(7)+1.5*V(7)+V(7)+V(7)+V(7)+V(7)&
             &+V(7)+V(7)+0.88*V(7)+V(7)+V(7)+V(7)+V(7)+2*V(7)+2*V(7)+V(7)+V(7)+V(7)+V(7)+V(7)+0.67*V(7)+0.5*V(7)+0.5*V(7)&
             &+V(7)+V(7)
