...
!
!   25 Aug 2009 - P. Le Sager - added variables t1 & t2, threadprivate
!                               declarations, and parameters Nhexit
...
MODULE gckpp_Integrator
  ...
  USE gckpp_Precision
  USE gckpp_Global, ONLY: FIX, RCONST, TIME, ATOL, RTOL
...
!$OMP THREADPRIVATE(  rkA, rkB, rkC, rkD )
...
!!$   INTEGER, SAVE :: Ntotal = 0
   ...
   T1 = TIN; T2 = TOUT
   CALL KppLsode( T1,T2,VAR,RTOL,ATOL,                &
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      INTEGER :: N
      REAL(kind=dp) :: V(NVAR), FCT(NVAR), T, TOLD
